...
where d.DEPARTMENT_NAME = '국어국문학과' and substring(s.STUDENT_SSN, 8, 1) in ('2', '4') and s.ABSENCE_YN = 'Y';
...
-- 6. 춘기술대학교는 총장을 제외하고 모든 교수들이 소속 학과를 가지고있다. 그럼 춘기술대학교 총장의 이름을 알아낼 수 있는 SQL 문장을 작성하시오.
...
from tb_student
where substring(ENTRANCE_DATE, 3, 2) = 19 and STUDENT_ADDRESS like '전주시%' and ABSENCE_YN = 'N'
