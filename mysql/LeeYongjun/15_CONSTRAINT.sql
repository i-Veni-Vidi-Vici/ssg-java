...
insert into
    user_notnull
values
    (1,'honggd','1234','홍길동','남','01012341234','dldydwns@naver.com'),
    (2,'sinsa','1234','신사임당','여','01056781234','sinsa@naver.com');
...
create table if not exists  user_unique(
    user_no int not null unique, -- 컬럼레벨 user_no의 중복값을 허용하지 않는다.
    user_id varchar(50) not null,
    user_pwd varchar(50) not null,
    user_name varchar(50) not null,
    gender char(1),
    ...
    constraint uq_user_unique_user_id unique(user_id), -- (테이블레벨)
...
-- [23000][1062] Duplicate entry 'dldydwns@naver.com' for key 'user_unique.uq_user_unique_email'
...
insert into
    user_primarykey
values
    # (1,'honggd','1234','홍길동','남','01012341234','dldydwns@naver.com'); -- [23000][1062] Duplicate entry '1' for key 'user_primarykey.PRIMARY'
    # (null,'honggd','1234','홍길동','남','01012341234','dldydwns@naver.com'); -- [23000][1048] Column 'user_no' cannot be null
...
#    prod_no = 300
#    and user_id = 'leess'
#    and order_date = '2024-04-23 11:19:15';
    (prod_no,user_id,order_date) = (300,'leess','2024-04-23 11:19:15');
;
-- 복합기본키의 대안
...
-- 외래키를 통해서 테이블과 테이블간의 관계가 만들어진다. (Relation DBMS)
-- 참조테이블의 참조컬럼은 PK, UQ제약조건이 걸려있어야한다.
-- 제공되는 값외엔 NULL을 허용한다.
...
insert into
    user_foreignkey
values
    (1,'honggd','1234','홍길동', 10,'남','01012341234','dldydwns@naver.com'),
    (2,'sinsa','1234','신사임당', 20,'여','01056781234','sinsa@naver.com');
...
-- 자기참조(같은 테이블 다른 컬럼을 참조, 상위 카테고리의 category_code를 하위 카테고리 ref_category로 참조)
...
create table if not exists user_check(
    ...
    phone char(11) not null,
    email varchar(100),
    constraint ck_user_check_gender check (binary gender in ('M','F')), -- 대소문자 구분이 필요한 경우 binary
...
insert into
    user_check
values
    (1,'honggd','1234','홍길동','M', 20,'01012341234','dldydwns@naver.com'),
    (2,'sinsa','1234','신사임당','F', 40,'01056781234','sinsa@naver.com');
