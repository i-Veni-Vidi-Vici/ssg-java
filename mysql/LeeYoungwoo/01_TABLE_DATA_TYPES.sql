...
-- SQL은 대소문자를 구분하지 않기 때문에 snake case 방식으로 단어를 연결해 사용한다.
...
-- decimal 고정소수타입 (지정한 소수점 이하로 정확한 데이터관리가 필요할 때)
...
values(
     ...
     1234.5678, -- 1234.57
     1234.5678, -- 1234.5678
     1234.5678  -- 1234.5678 0000 0000 0000 0000
);
...
values(
          ...
          1234.567801234567890, -- 1234.5678
          1234.567801234567890  -- 1234.5678 0000 0000 0000 0000
      );
...
-- TIMESTAMP YYYY-MM-DD HH:MM:SS 형식으로 관리.
    -- 지역대 정보를 제거하고 UTC로 관리. 불러올때는 지역대정보를 적용해서 보여줌.
    -- 국제화가 필요한 앱에 적합하다.
-- YEAR YYYY 형식으로 관리
...
select @@session.time_zone; -- STSTEM
