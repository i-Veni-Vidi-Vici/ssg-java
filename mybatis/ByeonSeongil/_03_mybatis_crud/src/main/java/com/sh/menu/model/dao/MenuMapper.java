 ...
 *  - 클래스명 -> mapper 태그 namespace속성
 *  - 추상메서드명 -> 쿼리태그(select, insert, update, delete)의 id속성
...
public interface MenuMapper {
    ...
    // int insertMenu(String menuName, int menuProce, int category, String orderableSatus);
