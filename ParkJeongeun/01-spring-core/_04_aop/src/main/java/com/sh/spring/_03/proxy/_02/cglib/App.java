...
public class App {
    public static void main(String[] args) {
        ...
        // 2. InvocationHandler객체 생성(target 메소드 대리호출, 부가기능 담당)
        ...
        // 스프링 ioc Container는 위와 같이 proxy빈을 생성 후 의존 주입함
        student.study(8);
        System.out.println(); // 자바 객체

        proxy.study(8);
        System.out.println(proxy.getClass()); // proxy 객체
    }
}