...
//        pstmt.setInt(3, menu.getCategoryCode());
     ...
     */
    @Test
    @DisplayName("객체지향관점의 상속을 DB에서는 동일하게 매칭할 수 없음")
    void test3() {
        // given
        // when
        // then
    ...
    /**
     * <pre>
     * 동일한 PK컬럼값을 조회한 경우, 객체는 동일해야 함 (주소값이 같은 하나의 객체)_객체지향
     * </pre>
     */
//    @Test
...
//        // then
//        assertThat(menu1).usingRecursiveComparison().isEqualTo(menu2); // 모든 값 동등
//        assertThat(menu1).isNotSameAs(menu2); // 하지만 같은 객체 아님
//    }
