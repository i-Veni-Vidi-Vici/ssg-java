...
class OrderServiceTest {
    ...
    /**
     * controller에서 주문데이터를 인자로 createOrder를 호출
     */
    @Test
    @DisplayName("주문 등록 트랜잭션")
    void test1() {
        // given : 현재 OrderMenuDto객체에는 orderCode가 설정되어있지 않음. OrderDto 등록 후 처리 가능
    ...
    /**
     * n건의 DML 중 한건이라도 예외가 던져지면, 전체 DML은 rollback 처리되어야 하고,
     * controller로 다시 예외가 던져져야 함
     */
    @Test
