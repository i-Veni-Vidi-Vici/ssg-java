...
/**
 * <pre>
 * 1. 날짜/시간 객체(java) -> 특정 형식 문자열로 바꿔서 출력할 수 있어야 함
 * 2. 특정 형식 문자열 -> 날짜/시각 객체(java)
 * </pre>
 */
public class App5 {
    public static void main(String[] args) {
        ...
        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy/MM/dd hh:mm:ss"))); // 2024/03/27 02:33:08 // hh 12시간제
        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy/MM/dd(E) HH:mm:ss"))); // 2024/03/27(수) 14:33:08 // HH 24시간제

        // 2. 문자열(날짜/시간)데이터를 객체 변환하기(parsing)
        String data1 = "2024-01-01"; // 날짜표기 표준형식
        LocalDate date1 = LocalDate.parse(data1, DateTimeFormatter.ofPattern("yyyy-MM-dd")); // 2024-01-01
        LocalDate date = LocalDate.parse(data1); // 2024-01-01
