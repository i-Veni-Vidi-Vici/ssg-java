...
public class LiteralApp {
    ...
    public static void main(String[] args) {
        ...
        //4. 문자(문자 1개) : 홑따옴표로 감싸서 표현
        System.out.println('a');
//        System.out.println('ab'); // compile error : 문법 제대로 작성X
//        System.out.println(''); // 문자 0개는 오류
        System.out.println('1'); //숫자여도 ''로 감싸져 있으면 문자
        //5. 문자열(문자 0~n개) : 쌍따옴표로 감싸서 처리
