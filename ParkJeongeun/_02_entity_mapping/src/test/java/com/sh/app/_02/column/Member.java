 ...
 * </pre>
 */
@Entity(name = "Member02") // 영속성 컨텍스트에서 관리되는 이름
@Table(name = "tbl_member02") // 실제 db테이블과 매핑되는 이름
@DynamicInsert // insert시 값이 null인 필드는 제외
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder // 아래 주석한 코드를 대신 작성해주는 어노테이션
public class Member {
    @Id
...
//            this.id = id;
//            return this; // 내부클래스객체를 반환해서 연속적으로 메소드를 호출할 수 있게 함 (메소드 체이닝기법)
//        }
