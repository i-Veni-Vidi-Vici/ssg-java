...
public class JpqlJoinTest {
    ...
    void test1() {
         ...
         */
        System.out.println(menus.size()); // 74
    ...
    void test4() {
        ...
        System.out.println(rows.size()); // 912
        rows.forEach((row) -> {
     ...
     */
    @Test
    @DisplayName("엔티티 연관관계가 있을 때 join - N+1 이슈")
    void test5() {
        // given
        String jpql = """
                select
    ...
    void test8() {
        ...
        MenuCategoryResponseDto dto = new MenuCategoryResponseDto(menu.getMenuCode(), menu.getMenuName(), category.getCategoryName());
        // then
