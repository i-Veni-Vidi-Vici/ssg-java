 ...
 *
 * 엔티티의 생명 주기
 * - 비영속(영속적이지 않는 경우), 영속, 준영속(한 번 갔다가 나오는 경우), 삭제 상태
 * - 대부분 비영속, 영속, 삭제일 것이다.
 * </pre>
 */
...
public class EntityLifecycleTest {
    ...
    void test1() {
        ...
        // when
        Menu menu2 = new Menu(); // menu와 내용은 같지만 다른 객체
    ...
    void test2() {
        ...
        try {
            entityManager.persist(menu); // 실제 영속하는 곳 (@GeneratedValue 쿼리 질의 insert into...)
    ...
    void test3() { // select쿼리가 한 번밖에 안 날아온다.
        // given
        Long menuCode = 10L;
        // when
