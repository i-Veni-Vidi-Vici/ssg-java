...
/**
 * <pre>
 * Spring 환경에서는 EntityManagerFactory, EntityManager 객체의 생명주기가 모두 Spring ApplicationContext 하위에서 관리된다.
 * 서비스단에서 처리해야 할 트랜잭션 범위설정, commit/rollback처리 모두 AOP를 이용해 별도로 분리되어 처리된다.
 * </pre>
 */
@SpringBootTest
