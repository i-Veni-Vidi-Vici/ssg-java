...
//        order.setTotalPrice(30000); // Entity 객체 하위 정보를 임의로 수정해서는 안된다.
        ...
        // 2. order는 Address를 알지 못하므로, DeliveryInfo에게 배송지 주소 변경을 요청
        // 3. DeliceryInfo가 Address를 알고 있으므로, 직접 Address객체를 변경한다.
//        order.getDeliveryInfo().setAddress(new Address("미국 캘리포니아", "샌프란시스코", "090807"));
        order.changeDeliveryAddress(new Address("미국 캘리포니아", "샌프란시스코", "090807"));
        System.out.println(order);
    }
}
