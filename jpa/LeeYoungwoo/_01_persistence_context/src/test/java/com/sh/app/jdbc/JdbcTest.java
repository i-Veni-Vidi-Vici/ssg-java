 ...
 *  1. SQL 직접 작성, 필요한 데이터 반환, 관련코드 중복
 *  2. SQL 의존개발 - 요구사항이 변하면 SQl을 수정해야 한다.
 *  3. 패러다임 불일치 (연관관계, 자바진영의 상속, 객체 그래프 탐색등에 구현에 있어 DB Table과 매칭되지 않음)
 *  4. 동일서 옵장 문제 : pk로 조회한 두 객체가 다를 수 있다.
 * </pre>
 */
...
public class JdbcTest {
    ...
    void test4() throws SQLException {
        ...
        // then
        assertThat(menu1).usingRecursiveComparison().isEqualTo(menu2); // 모든값이 동등하다
