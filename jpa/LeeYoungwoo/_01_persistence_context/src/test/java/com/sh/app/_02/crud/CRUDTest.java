...
public class CRUDTest {
    ...
    /**
     * <pre>
     * EntityTransaction 객체를 통해서 트랜잭션 범위 및 commit/rollback처리를 해줘야 한다.
     * </pre>
     */
    @Test
    ...
    void test3() {
        ...
        try {
            entityManager.persist(menu); // 영속성 컨텍스트에 menu 엔티티 객체를 저장 (@GeneratedValue 설정 시 insert 쿼리는 바로 실행. PK를 알아야 영속성컨텍스트에 저장가능하다.)
