...
class LegacyMenuRepositoryTest {
    @Autowired
    private LegacyMenuRepository menuRepository;
    ...
    /**
     * <pre>
     * @Transactional 를 통해서 트랜잭션 범위를 지정할 수 있다.
     ...
     * - Rollback(false)를 통해서 DML 실제 적용할 수 있다 (rollback되지 않음
     * </pre>
     */
    @Transactional
    ...
    void test2() {
        Long menuCode=15L;
        int newMenuPrice=12345;

        int result=menuRepository.updateMenuPrice(menuCode,newMenuPrice);
