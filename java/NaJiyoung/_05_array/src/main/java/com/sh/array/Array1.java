...
//        int arr[];    // c-family 스타일도 가능
        ...
        // 2. 배열 객체 할당 - 크기지정 필수
        arr = new int[5];
        System.out.println(arr);    // [I@7a8197d   int[] @ 객체식별값(hashCode)
...
//        boolean[] bools = new boolean[] {true, false, true, false, true};   // 크기 명시 안함.
     ...
     */
    public void test5() {
        String[] names = new String[] {"나지영", "박수빈", "정예진", "정인겸"};
//        String[] names = {"나지영", "박수빈", "정예진", "정인겸"};
        // 반복문을 통해 출력
