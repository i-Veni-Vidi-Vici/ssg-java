package com.ssg.test.ohigiraffers.hw1.model.dto;
...
public class EmployeeDTO {
    ...
    public String information() {
        return String.format("%d, %s, %s, %s, %d, %c, %d, %.2f, %s, %s", this.empNo, this.empName, this.dept, this.job, this.age, this.gender, this.salary, this.bonusPoint, this.phone, this.address);
    }
