 ...
 *  - 단어 사이의 연결을 _로 처리하지 않는다. (Snake_Casing X)
...
//        String my name = "신사임당";    // 공백 특수문자는 사용할 수 없다.
        ...
        // 관례적 명명법
        String aslkdasfkajslfk = "abc"; // 변수명 길이에 제한은 없지만, 적절한 길이로 작성해야 한다.
        System.out.println(aslkdasfkajslfk);
        int maxAge = 20;    // 카멜케이싱
        ...
        double goHome = 3.7;    // 변수명은 명수형으로 작성한다. 메소드명을 동사형으로 작성하다.
        double home = 3.8;
