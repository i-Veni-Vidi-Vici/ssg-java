...
//        DevType dev4 = DevType.valueOf("WEBBBBBBBBBBBBB"); // java.lang.IllegalArgumentException: No enum constant com.sh._enum._03.advanced.DevType.WEBBBBBBBBBBBBB
        System.out.println(dev4); // 7777
        // 1234 -> DevType.WEB
        DevType dev5 = DevType.valueOf(1234); // WEB
