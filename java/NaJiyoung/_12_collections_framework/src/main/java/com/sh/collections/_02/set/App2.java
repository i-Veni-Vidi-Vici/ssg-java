 ...
 * <pre>
 * 커스텀 클래스 Set으로 관리하기
 * - 중복 제거를 위한 equals/hashCode 먼저 오버라이드 하기
 * </pre>
 */
public class App2 {
    public static void main(String[] args) {
        ...
        // equals/hashCode 내가 원하는대로 오버라이드 필수 - 오버라이드 하지 않을 시 다 다른 객체로 간주한다.
        // equals/hashCode 비교 후, equals결과가 true, hashCode가 동일할 때 같은 객체로 간주한다.
