...
//        Map map2 = new HashMap();
        ...
        // put(K, V) 요소저장
        System.out.println(map.put("홍길동", 23)); // 중복 없기 때문에 null 반환
        map.put("신사임당", 40); // int -> Integer.valueOf(40) auto-boxing 처리
//        map.put(50, "이순신");

        // 중복된 key로 저장
        Integer removed = map.put("홍길동", 33); // 중복된 key의 value 33 저장
        System.out.println("removed = " + removed); // 제거된 value 23 반환
        ...
        System.out.println("홍길동 = " + value); // 홍길동 = 33
        ...
        System.out.println(map); // {신사임당=40}
