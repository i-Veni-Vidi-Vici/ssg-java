 ...
 * - 만약, 필드를 가지고 있다면, 기본형을 제외한 모든 필드 역시 Serializable인터페이스를 구현하고 있어야 한다.
 * </pre>
 */
public class App4 {
...
//            oos.writeObject(user);
            ...
            users.add(new User(3L, "lesss", "1234", "이순신", 'M', new Phone("01055556666"), 3000, LocalDateTime.now(), true));
