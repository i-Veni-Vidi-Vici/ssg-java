...
public class App {
    public static void main(String[] args) {
        String path = "https://docs.oracle.com:443/javase/8/docs/api/java/lang/String.html?name=hellojava#method.summary"; // :443은 기본 포트라서 생략 가능
        ...
        try {
            ...
            System.out.println("ref : " + url.getRef()); // anchor(북마크) 페이지 내 특정부분 method.summary
