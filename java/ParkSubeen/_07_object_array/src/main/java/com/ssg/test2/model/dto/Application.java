package com.ssg.test2.model.dto;

import com.sh._02.member.MemberManager;
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            if(studentIndex < students.length) {
                ...
                students[studentIndex] = new StudentDTO(grade, classroom, name, kor, eng, math);
        ...
        for(int i = 0; i < studentIndex + 1; i++) {
            double avg = (students[i].getKor() + students[i].getEng() + students[i].getMath()) / 3.0;
