...
public class App3 {
    public static void main(String[] args) {
        ...
        range.forEach((r) -> System.out.println("8 * " + r + " = " + (8 * r)));

        // 피드백 전
//        IntStream dan = IntStream.range(2, 10);
//        IntStream num = IntStream.range(1, 10);
//        dan.forEach((d) ->
//                num.forEach((n) -> System.out.println(d + " * " + n + " = " + (d * n)))
//        );

        // 피드백 후
//        IntStream dan2 = IntStream.range(2, 10);
//        Supplier<IntStream> intStreamSupplier = () -> IntStream.range(1, 10);
//        dan2.forEach((d) -> {
//            intStreamSupplier.get().forEach((n) -> System.out.println(d + " * " + n + " = " + (d * n)));
//        });
