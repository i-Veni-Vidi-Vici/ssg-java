 ...
 * - Map<Book, Integer> Book 객체를 key 로, 판매량 데이터 (int)를 value 로 관리
 */
public class App3 {
    public static void main(String[] args) {
        ...
        bookSaleMap.put(new Book(200L, "신사동 가로수길", "신사임당", 30000), 20);
        bookSaleMap.put(new Book(300L, "해시계 파헤치기", "장영실", 17000), 30);
    }
}
