 ...
 *  - 사용자는 키오스크에 저세된 메뉴를 선택할 수 있다.
 *  - 커피를 주문할때 종류, 온도, 수량 등을 선택할 수 있다.
 ...
 *      <-----------주문확인----------
 *      -----------주문승인---------->
 *           ---주문에 따라 커피를 만들어라---> 바리스타 ---재고량을 확인---> 커피제조
 * 4. 객체가 수신해야 하는 메세지 (메소드)
 * - 키오스크 : 메뉴제공, 사용자 선택에 따라 주문생성, 생성된 주문을 보여달라, 바리스타에게 주문 전달
 * - 바리스타 : 주문에 따라 커피를 제조(커피를 제공)
 * 5. 클래스 설계
 * </pre>
 */
public class App {
