...
//        RabbitFarm<Animal> animalFarm4 = new RabbitFarm<>(new Snake());
        ...
        RabbitFarm<Rabbit> rabbitFarm = new RabbitFarm<>(new Rabbit()); // <> 안이 extends, 뒤에 new XX는 다형성때문에 가능한 것
...
//        AnimalFarm<LocalDate> localDateAnimalFarm = new AnimalFarm<>(); // 상속X 사용불가
