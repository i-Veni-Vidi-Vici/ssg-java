...
// import문 - 다른 package에 클래스를 가져다 사용하는 경우
 ...
 * - 도메인(예시> blog.naver.com -> com.naver.blog)을 뒤집어서 3레벨 이상 사용하는 것을 권장한다.
 * </pre>
 */
public class App1 {
    public static void main(String[] args) {
//      App1 app = new App1(); 약식표현
...
//      App1.test2();
        ...
        // method패키지의 App1 클래스의 a, b, c 메소드를 호출
