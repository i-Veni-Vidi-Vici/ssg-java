...
public class App {
    public static void main(String[] args) {
        // call by value
//        int n = 10; // 메소드 안에서 작업해도 원본값 바뀌지 않음
//        Item callByValue = new Item();
//        callByValue.test(n); // 여기서 n 매개 인자.
...
//        callByReference.test2(arr);
        ...
        // - 더하기 연산시 "Hello world" + "Byebye world")할 때, 기존 "Hello world"
