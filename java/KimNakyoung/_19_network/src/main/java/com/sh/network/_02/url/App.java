...
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("host : " + url.getPort()); // 443
            ...
            System.out.println("ref : " + url.getRef()); // anchor (닻) 앵커 (북마킹) 페이지내 특정 부분 method.summary

            // 해당 URL 자원 가져오기 (통신)

            URLConnection urlConnection = url.openConnection();
            // 문자기반보조스ㅡ림 - 브릿지스트림(형변환스트림) - byte기반 입력스트림
