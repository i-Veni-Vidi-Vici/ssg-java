...
//                .forEach(System.out::println);
        ...
        // 숫자가 아닌 데이터 제거
        Stream.of("1,000,000","$500","4달러","500원만 주세여")
//                .map((str) -> str.replaceAll("[^0-9]","")) // 숫자를 찾아서 제거해주세요 // 숫자[0-9],숫자가 아닌 문자 [^0-9]
                .map((str) -> str.replaceAll("[^0-9]","")) // 숫자가 아닌 문자를 찾아서 제거해주세요 // 숫자[0-9],숫자가 아닌 문자 [^0-9]
