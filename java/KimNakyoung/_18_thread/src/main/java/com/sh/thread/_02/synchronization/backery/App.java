 ...
 *
 *  구현해야할 동기화 기능
 *  - 손님은 접시에 비어있을 때 요리사가 빵을 만들길(notify) 기다려야 한다(waiting).
 *  - 요리사는 접시가 비어있지 않으 때 손님이 빵을 먹길(notify) 기다려야 한다.(waiting).
...
public class App {
    public static void main(String[] args) {
        ...
        Thread consumer = new Thread(new Consumer(plate),"손님"); // 람다로 적으면 더 간편하지않나요? 지금은 아님..
