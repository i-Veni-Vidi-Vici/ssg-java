 ...
 * ### 객체 비교 원칙
 *
 * - equals 비교 결과가 true라면, 동일한 hasdCode를 반환해야 함
...
public class App2 {
    public static void main(String[] args) {
        ...
        System.out.println(book3 == book2); //false

        //동등 비교 - 특정 필드의 값이 같은지 비교해서 모두 같다면, 두 객체를 동등하다고 판단
        System.out.println(book1.equals(book2)); //false
        System.out.println(book2.equals(book3)); //true -> 주소값이 같은지를 비교할 때, Book클래스를 만들줘서 true가 됨
