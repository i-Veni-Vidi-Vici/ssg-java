...
public class App4 {
    public static void main(String[] args) {
        ...
        List<String> names = Arrays.asList("홍길동", "고길동", "홍진경"); //변경불가능한 Immutable ArrayList가 반환됨 -> 수정할 수 없는 💫읽기용💫으로 만드는 것!!
        String familyName = "홍";
        List<String> resultList = biFunction.apply(names, familyName);
        System.out.println(biFunction.apply(names, familyName));// [홍길동, 홍진경]
