...
public class App4 {
    public static void main(String[] args) {
        ...
        result = stringList.stream().allMatch((str) -> str.length() > 4);
        System.out.println(result); // false -> 모든 문자가 4글자 이상이 아니기 때문
        ...
        //이름 글자수가 3글자보다 많은 이웃이 있는지 검사 -> true
        ...
        System.out.println(supplier.get().noneMatch((person -> person.getAge() < 20))); //20살 미만인 사람이 한명도 없어? -> 부정표현은 조심하기!
