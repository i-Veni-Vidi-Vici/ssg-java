...
public class App4 {
    public static void main(String[] args) {
        ...
        try {
            ...
            prop.store(new FileWriter("KimDonghyun/_12_collections_framework/dataSource.properties"), "db configuration");
            prop.storeToXML(new FileOutputStream("KimDonghyun/_12_collections_framework/dataSource.xml"), "db configuration");
        ...
        try {
//            prop2.load(new FileReader("KimDonghyun/_12_collections_framework/dataSource.properties"));
            prop2.loadFromXML(new FileInputStream("KimDonghyun/_12_collections_framework/dataSource.xml"));
