...
public class App5 {
    public static void main(String[] args) {
        Queue<Integer> queue = new LinkedList<>(); // new Queue사용하면 안됨
        ...
        // Queue인터페이스에서는 indexOf 사용할 수 없다.
        // Collection#contains는 사용가능하다.
        System.out.println(queue.contains(2));
        queue.remove(Integer.valueOf(2));  // index가 아닌 Object를 인자한 것
