 ...
 * <pre>
 * LinkedList 연결리스트
 * - 내부의 배열을 가진 ArrayList와 달리 노드(요소)를 연결해서 데이터를 관리
...
public class App3 {
    public static void main(String[] args) {
        ...
        System.out.println(list.indexOf(10000)); // -1(존재하지 않은 수로 -1 반환)

        list.clear(); // 모든 요소 삭제
        System.out.println(list.isEmpty()); // false라면 요소가 1개 이상, true라면 요소가 0개라는 의미
