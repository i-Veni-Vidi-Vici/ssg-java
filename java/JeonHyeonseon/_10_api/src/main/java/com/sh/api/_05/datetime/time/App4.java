...
public class App4 {
    public static void main(String[] args) {
        ...
        System.out.println(now.isAfter(past)); // true, true/false를 나타내는 코드
        ...
        System.out.println(period); // P(period)1Y5D(1년 5일 차이난다는 의미)
        ...
        System.out.println("시간 차이 : " + ChronoUnit.HOURS.between(past, future)); // 365
