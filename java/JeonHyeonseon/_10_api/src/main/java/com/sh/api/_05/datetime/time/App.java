...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println(localTime1); // 12:21:14.034702600
        System.out.println(localTime2); // 14:15:30

        // LocalDateTime 날짜/시간
        LocalDateTime localDateTime = LocalDateTime.now();
        LocalDateTime localDateTime2 = LocalDateTime.of(2024, 3, 4, 12, 30, 25);
        // yyyy-MM-ddThh:mm:ss.SSSSSSSSS   -> T는 구분자이다.
        System.out.println(localDateTime); // 2024-03-27T12:22:23.816443800
        System.out.println(localDateTime2); // 2024-03-04T12:30:25

        // ZonedDateTime 지역정보 포함
        ZonedDateTime zonedDateTime = ZonedDateTime.now();
        ZoneId zoneId = ZoneId.of("America/New_York");  // 지역대를 명시할 수 있다.
        ...
        System.out.println(zonedDateTime); // 2024-03-27T12:25:58.055267+09:00[Asia/Seoul]
        System.out.println(zonedDateTime2); // 2024-03-04T12:30:10-05:00[America/New_York]
        System.out.println(zonedDateTime3); // 2024-03-27T12:33:52.493782200+09:00[Asia/Seoul]
    }
}
