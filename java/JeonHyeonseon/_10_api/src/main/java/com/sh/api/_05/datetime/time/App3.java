...
public class App3 {
    public static void main(String[] args) {
        ...
        System.out.println(localDateTime); // 2024-03-27T12:49:49.200610300
        System.out.println(localDateTime.hashCode()); // 1121614117

        LocalDateTime localDateTime2 = localDateTime.plusMinutes(60); // 무조건 새객체를 반환. 기존객체는 변경하지 않는다.
        System.out.println(localDateTime2); //  2024-03-27T13:49:49.200610300
        System.out.println(localDateTime); // 2024-03-27T12:49:49.200610300
        System.out.println(localDateTime.hashCode()); // 1121614117

        LocalDateTime localDateTime3 = localDateTime.minus(1, ChronoUnit.DAYS);
        System.out.println(localDateTime3); // 2024-03-26T14:08:20.979850800
    }
}
