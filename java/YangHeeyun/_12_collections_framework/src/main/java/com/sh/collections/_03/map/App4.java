...
public class App4 {
    public static void main(String[] args) {
        ...
        try {
            ...
            prop.store(new FileWriter("YangHeeyun/_12_collections_framework/dataSource.properties"), "db configuration");
            prop.storeToXML(new FileOutputStream("YangHeeyun/_12_collections_framework/dataSource.xml"), "db configuration");
        ...
        try {
//            prop2.load(new FileReader("YangHeeyun/_12_collections_framework/dataSource.properties"));
            prop2.loadFromXML(new FileInputStream("YangHeeyun/_12_collections_framework/dataSource.xml"));
