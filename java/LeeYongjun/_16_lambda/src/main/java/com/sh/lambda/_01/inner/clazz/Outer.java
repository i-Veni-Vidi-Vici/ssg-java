...
//            System.out.println(n); // static 자원은 non-static자원에 접근할 수 없다.
        }
    }
    ...
    public void test(){
//        Inner3 instacne = new Inner3(); // 선언전에 사용불가!
        // 지역변수를 선언한 것과 같다.
        class Inner3{
