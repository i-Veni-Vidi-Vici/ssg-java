 ...
 * 4. 뒤로가기를 누르면, 현재 url은 forwardStack에 쌓이고, backwardStack에 있는 url을 current에 대입한다.
 * 5. 앞으로 가기를 누르면, 현재url은 backwardStack에 쌓이고. forwardStack의 url을 current에 대입한다.
 * </pre>
 */
public class HistoryApp {
    ...
    public void goToUrl(String url){
        ...
        if(this.current != null){
            this.backwardStack.push(current);
        }
