...
public class App2 {
    public static void main(String[] args) {
        ...
        list.add(2, new Book(150L, "골목대장", "운봉준", 27000));
...
//        Collections.sort(list, new PriceAscending().reversed()); // 가격 내림차순
        ...
        // 익명클래스 - 클래스 선언 + 객체 생성 동시에 하는 방법. 클래스 이름이 없다. 1회용
        ...
        Collections.sort(list,(Book o1, Book o2) -> {return o1.getAuthor().compareTo(o2.getAuthor());});
