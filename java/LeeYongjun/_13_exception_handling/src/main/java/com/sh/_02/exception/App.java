 ...
 * - 예회처리 : try.catch절을 통해서 예외발생시 처리구문을 작성(정상흐름 복구)
 * </pre>
 */
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("제수를 0이상의 정수로 설정해주세요...");
        }
        ...
        try {
            ...
            System.out.println("str의 값이 null이면 안됩니다...");
        }
        ...
        try {
            ...
            // 오류가 발생했을때 실행할 코드 - catch절이 실행되면, 예외처리되고 정상흐름 복구된다.
