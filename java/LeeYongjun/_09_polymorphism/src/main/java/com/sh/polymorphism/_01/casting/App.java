 ...
 * <pre>
 * 다형성 Polymorphism
 * - 하나의 인스턴스가 상속관계에 있는 여러가지 타입으로 가질 수 있다.
...
//        app.test3();
     ...
     * 동적바인딩
     * - 상속/다형성이 적용되고, 해당 메소드를 오버라이드했다면, 호출시 실행시간에 객체기준의 메소드를 다시 바인딩하는 것
     * </pre>
     */
    private void test4() {
...
//        Tiger tiger = (Tiger) animal; //ClassCastExceoption 예외 발생!
     ...
     */
    private void test2() {
        Animal animal = new Rabbit(); //Rabit -> Animal : upcasting
