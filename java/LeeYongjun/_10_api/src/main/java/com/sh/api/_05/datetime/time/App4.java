...
public class App4 {
    public static void main(String[] args) {
        ...
        System.out.println("년도 차이 : " + period.getMonths());
        System.out.println("년도 차이 : " + period.getDays());
        ...
        System.out.println("년도 차이 : " + ChronoUnit.YEARS.between(now,future));
        System.out.println("월 차이 : " + ChronoUnit.MONTHS.between(now,future));
        System.out.println("일 차이 : " + ChronoUnit.DAYS.between(now,future));
        System.out.println("시간 차이 : " + ChronoUnit.HOURS.between(now,future));
        System.out.println("분 차이 : " + ChronoUnit.MINUTES.between(now,future));
        System.out.println("초 차이 : " + ChronoUnit.SECONDS.between(now,future));
    }
}
