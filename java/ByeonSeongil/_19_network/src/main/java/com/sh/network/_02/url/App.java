...
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("query : " + url.getQuery()); // name=hellojava
            System.out.println("ref : " + url.getRef()); // anchor 앵커(북마크) 페이지내 특정부분 method.summary

            // 해당 URL 자원 가져오기 (통신)
            URLConnection urlConnection = url.openConnection();

            // 문자기반보조스트림 - 브릿지 스트림 - byte기반 입력스트림
