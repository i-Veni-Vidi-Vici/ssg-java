...
//        Member honggd = new Member("honggd", MemberRole.M, MemberRole.A); // 혼용시 컴파일오류 유발 -> 실수하기 어렵다.
        ...
        // enum은 단일인스턴스를 사용함 (싱글턴) -> 동일비교(주소값비교) 가능
...
//        MemberRole memberRole = new MemberRole(); // new 연산자 호출 불가
        ...
        // MemberRole.M과 Gender.M은 구분이 가능함

        // enum toString처리를 통해 실제 이름을 문자열로 반환받을 수 있다.
        System.out.println(MemberRole.M); // "M"
...
//        printRole(Gender.M);
        ...
        Subject subject3 = new Subject(SubjectType.JAVA, "웹 언어", 20);
