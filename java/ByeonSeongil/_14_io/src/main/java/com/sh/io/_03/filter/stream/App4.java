...
//                    'M', new Phone("101010"),1000, LocalDateTime.now(), true);
//            oos.writeObject(user);

            List<User> users = new ArrayList<>();
            users.add(new User(1L, "honggd", "1234", "홍길동",
                    'M', new Phone("101010"),1000, LocalDateTime.now(), true));
            users.add(new User(2L, "honggd", "1234", "r",
                    'M', new Phone("101010"),1000, LocalDateTime.now(), true));
            users.add(new User(3L, "honggd", "1234", "afdgsfg",
                    'M', new Phone("101010"),1000, LocalDateTime.now(), true));
