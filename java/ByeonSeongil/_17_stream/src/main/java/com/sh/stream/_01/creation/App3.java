...
public class App3 {
    public static void main(String[] args) {
        ...
        stream.forEach((s) -> System.out.println("8 x " + s + "=" + (8 * s)));
        IntStream stream5 = IntStream.range(2, 10);
        stream5.forEach((a) -> IntStream.range(1, 10).forEach((b) -> System.out.println(a + " x " + b + " = " + (a * b))));
