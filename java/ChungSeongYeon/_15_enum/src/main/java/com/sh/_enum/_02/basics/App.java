...
//        Member honggd = new Member("honggd", Gender.M, MemberRole.M); // 혼용시 컴파일오류 유발 -< 실수하기 힘듬
        ...
        MemberRole memberRole1 = MemberRole.M; // new MemberRole()
...
//        printRole(Gender.M); // 컴파일 오류
        ...
        printRole(SubjectType.JAVA);
        printRole(SubjectType.MYSQL);
        printRole(SubjectType.HTML);
    ...
    private static void printRole(SubjectType subjectType) {
        System.out.println("과목 권한은 " + subjectType + "입니다.");
    }
