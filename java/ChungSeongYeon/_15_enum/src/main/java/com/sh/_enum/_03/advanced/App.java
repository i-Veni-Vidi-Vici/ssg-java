...
//        DevType dev4 = DevType.valueOf("WEBBBBBBBBBBBBBBBB"); IllegalArgumentException
        System.out.println(dev4);
        // 1234 -> DevType.WEB
        DevType dev5 = DevType.valueOf(1234); // 없으면 만들면 된다.
...
//        String name = sc.next();
//        System.out.println("당신의 개발직종 선택하세요 WEB/IOS/ANDROID : ");
//        String type  = sc.next();
