...
public class LiteralApp2 {
    ...
    public static void main(String[] args) {
        ...
        // ascii 코드 표에 의해서 a는 97, b는 98로 변환된다.
        ...
        System.out.println("hello" + "world"); // 여러개의 문자열을 한개의 문자열로 합니다.
...
//        System.out.println(true * false); // 컴파일 오류
        ...
        // 프로그램은 기본적으로 위에서 아래로, 왼쪽에서 오른쪽으로 코드가 실행된다.
        System.out.println("기차" + 10 + 20); // "기차30"이 아닌 "기차 1020"
        System.out.println("기차" + (10 + 20)); // "기차30"
        System.out.println("김밥" + 'a' + 'b'); // "김밥ab"
        System.out.println('a' + 'b' + "김밥"); // 프로그램은 왼쪽에서 오른쪽으로 일반적으로 실행되기 때문에 'a' + 'b' 먼저 연산 되므로 "195김밥"
        System.out.println();
