 ...
 *     - 다른 매개변수와 섞어 쓰는 경우, 마지막에 한번만 사용 가능하다.
 * </pre>
 */
...
public class ParameterTest {
    ...
    /**
     * int... nums
     * - 개수 제한없이 매개인자를 담을 수 있는 int[] 배열이다.
     * @param nums
     * @return
     */
...
//    public void test2(String... strs, int n) {}   // 마지막에 작성해야함
//    public void test2(String... strs, int... n) {}    // 한번만 작성해야함
}
