 ...
 * - Random#nextInt(int):int 경우의 수, 최소값을 이용해 특정 범위의 난수 생성 (#이 들어가면 non-static 메소드)
 * - Random#nextDouble():double
 * - Random#nextBoolean():boolean
 *
 * - Random#nextInt 난수생성 공식 : Random#nextInt(경우의 수) + 최소값
 * </pre>
 */
...
public class App {
    public static void main(String[] args) {
        ...
        // 0 ~ 9
        System.out.println(rnd.nextInt(10) + 0); // rnd.nextInt(10)은 0~9
