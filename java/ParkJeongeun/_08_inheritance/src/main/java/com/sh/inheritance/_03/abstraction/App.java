 ...
 * <pre>
 * 상속구조의 객체지향 설계
 * - 부모의 필드/메소드를 자식클래스가 선언없이 사용가능
 * - 공통점이 있는 여러개의 자식클래스에서 중복된 부분만 뽑아서 부모클래스 설계 가능
 * - 중복된 부분을 부모클래스에서 한번만 관리하므로 유지보수성이 좋음
 * </pre>
 */
public class App {
    public static void main(String[] args) {
        ...
        Computer computer2 = new Computer("com1234", "삼성", "갤럭시북",
                2_000_000, LocalDate.now(), "i9", 32, 1000, "Windows11");
