...
//                bw.flush(); //즉시 쓰기 메서드 별로추천하진 않음
        ...
        BufferedReader br = null;
            try {
                ...
                //BufferedReadder#readLine() 한줄씩 읽어서 반환 (개행문자까지 읽어서 개행문자 버리고 반환)
                String data = null;
