...
/**
 * <pre>
 * Object#equlas, Object#hashCode 오버라이드를 해볼것임
 * - 객체 동일성 (Identity) - heap 영역의 같은 객체인가를 물어보는 것 (주소값이 같은가?) -> == 동등비교 연산자로 처리
 * - 객체 동등성 (Equality) - 객체가 가진 내용이 같은가? (특정필드의 값들이 동일한가?) -> equals 메소드(오버라이드)
 *
 *
 *  객체비교 원칙
 *  -equals 비교 결과가 true라면
 * </pre>
 */
public class App2 {
    ...
    public static void main(String[] args) {
        ...
        //동일성 비교
        System.out.println(book1.hashCode()); //해시코드의 값이 다르다는것은 다른 객체
        ...
        System.out.println(book5.equals(book5)); //false
