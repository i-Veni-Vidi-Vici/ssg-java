 ...
 *   - 윤초(세계 협정시에 사용하는 세슘 원자시계와 태양시사이의 오차를 반영)를 반영하지 못한다
 * </pre>
 */
public class App2 {
...
//        Calendar cal = new Calendar();
        ...
        //특정 일자로 캘린더 객체 생성
        //2024-03-04 12 : 30 : 30
        Calendar sometime = new GregorianCalendar(2024, 2, 4, 3, 12, 30);
        ...
        //날짜 차이 (long타입으로 변환)
        Calendar todday = new GregorianCalendar();
        Calendar thisWeekend = new GregorianCalendar(2024, 3 - 1, 30);

        //미래 long - 과거 long / 1000(초) / 60 / 60 / 24
        double diff = thisWeekend.getTimeInMillis() - todday.getTimeInMillis();
        System.out.println(diff);
        diff = diff / 1000 / 60 / 60 / 24;
        System.out.println(diff);
        diff = Math.ceil(diff);// 올림처리 2.xxx -> 3
