...
// *를 사용하면, 특정 패키지의 모든 클래스 동시 import 가능
...
//        App1.test2();
        ...
        String str = "ㅋㅋㅋ"; // import java.lang.String;

        // method 패키지의 App1 클래스의 a, b, c 메소드를 호출
        // 동일한 이름의 클래스를 가져다 쓰는 경우, import문이 아닌 풀네임으로 작성해야 한다.
        com.sh.method.App1 methodApp = new com.sh.method.App1();
        methodApp.a();
        methodApp.b();
        methodApp.c();
    }
