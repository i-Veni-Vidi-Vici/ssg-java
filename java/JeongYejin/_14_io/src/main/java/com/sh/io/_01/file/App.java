 ...
 */
public class App {
    public static final String ROOT = "JeongYejin/_14_io/"; // 프로젝트루트 (상대경로)
    public static void main(String[] args) {
        File file = new File(ROOT + "test.txt");
        System.out.println(file); // 파일경로로 toString 오버라이드 되어
        System.out.println(file.getParent()); // JeongYejin\_14_io
        System.out.println(file.getName()); // test.txt
        System.out.println(file.exists()); // false -> true
        System.out.println(file.isFile()); // false -> true
        System.out.println(file.isDirectory()); // false
        System.out.println(file.length()); // 파일의 크기 0 -> 61
        ...
        try {
            ...
            System.out.println(file.getAbsolutePath()); // C:\Workspaces\java_workspace\JeongYejin\_14_io\test.txt
        } catch (IOException e) {
            e.printStackTrace();
        }
