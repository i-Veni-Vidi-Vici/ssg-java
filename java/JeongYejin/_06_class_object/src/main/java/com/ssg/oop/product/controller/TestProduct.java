...
public class TestProduct {
    public static void main(String[] args) {
        Product product = new Product("ssgnote6", "갤럭시노트6", "경기도수원", 940000, 10.0);
        ...
        product.realInformation(product.realPrice());
        product2.realInformation(product2.realPrice());
        product3.realInformation(product3.realPrice());
    }
}
