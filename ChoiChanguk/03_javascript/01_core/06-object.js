...
const user = {
  ...
  const name = 'age';
  console.log(user[name]); // 23 user의 name변수의 대입된 값 속성
  ...
  // student객체에 school속성이 없으면, school : 'ssg학교'추가
  'school' in student ||(student.school='ssg학교')// 만약 school 속성이 없으면 || 오른쪽 실행
  // 만약 없다면 student.school 안에 값을 반환
  console.log(student);
