...
class OrderServiceTest {
    ...
    /**
     * conttroller에서 주문데이터를 인자로 createOrder를 호출한다
     */

    @Test
    @DisplayName("주문 등록 트랜잭션")
    void test1() {
        // given : 현재 OrderMenuDto 객체에는 orderCode가 설정되있지 않다. 이건 OrderDto 등록 후 처리가 가능할 거 같다
    ...
    /**
     * n건의 DML중 한 건이라도 예외가 던져지면, 전체 DML은 rollback처리되어야 하고,
     * contorller로 다시 예외가 던져져야 한다.
     */
    @Test
