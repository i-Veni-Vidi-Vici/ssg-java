 ...
 *
 * @Transactional 메소드안에서 던져진 예외가 RuntimeException 후손인 경우만, rollback 처리한다 (기본값)
...
public class OrderService {
    /**
     * @Mapper 구현클래스 bean이 의존 주입되서 처리된다
...
//    @Transactional // commit, rollback을 이놈이 해준다
    public int createOrder(OrderDto orderDto) {
        ...
        return result; // 하나라도 잘못됐으면 에러유발, 0이 아닌 값만 넘어가면 된다
    }
}
