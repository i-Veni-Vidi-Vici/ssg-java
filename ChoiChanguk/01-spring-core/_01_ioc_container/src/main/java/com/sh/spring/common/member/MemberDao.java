...
public class MemberDao {
    ...
    public MemberDao() {
        ...
        // MemberDao 하위에서 관리되는 MemberDto객체는 빈이 아니다
        this.memberMap.put(1L,new MemberDto(1L, "honggd","1234","홍길동"));
        this.memberMap.put(1L,new MemberDto(2L, "sinsa","1234","신사임당"));
    ...
    public boolean addMember(MemberDto member) {
        this.memberMap.put(member.getId(),member); // key값과 연결되었던, 이전 값이 반환한다
        return true;
    }
}
