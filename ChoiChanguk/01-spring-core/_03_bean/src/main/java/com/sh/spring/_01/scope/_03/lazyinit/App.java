...
public class App {
    public static void main(String[] args) {
         ...
         * second 장바구니 : [Bread(bakedAt=2024-06-12), Beverage(super=Product(name=딸기우유, price=1500), capacity=500), Beverage(super=Product(name=지리산암반수, price=3000), capacity=1800), Beverage(super=Product(name=지리산암반수, price=3000), capacity=1800)]
         */
