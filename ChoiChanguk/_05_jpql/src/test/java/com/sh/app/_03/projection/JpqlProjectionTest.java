...
public class JpqlProjectionTest {
    ...
    void test1() {
        ...
        // 반환받은 Category객체(영속객체) 수정한다면 // update 쿼리가 날라간다 = 영속컨텍스트에 있던 애가 바뀌어서,
        // commit을 날렸는데 어?? 이거 영속성에 있떤 애가 바뀌었네?? 그럼 update문 써야겠다 한다
    ...
    void test4() {
        ...
        String jpql= """
                select
                    ...
                    c.categoryCode,c.categoryName,123
                    ) 
                from Category03 c""";
