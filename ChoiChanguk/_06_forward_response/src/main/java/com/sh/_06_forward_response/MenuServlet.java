 ...
 * - 첫번째 서블릿이 요청핸들링 / 업무로직을 담당, 두번째 서블릿이 응답을 작성하는 경우가 많다
 */
@WebServlet("/menu")
public class MenuServlet extends HttpServlet {
    Map<String , List<String>> menuMap=Map.of(
            "rice",List.of("김밥","김치볶음밥","오므라이스"),
            "meat",List.of("대패삼겹살","스테이크","족발"),
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Request 객체의 속성으로 저장하면, 위임받는 서블릿에서 꺼내쓸 수 있다.
        request.setAttribute("menus",menus); // 이 방법밖에 없다
