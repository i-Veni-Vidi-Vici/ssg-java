package com.sh._01_servlet_lifrcycle;
 ...
 *
 * - HttpServlet (웹요청을 처리하는 데 필요한 설정을 가진 클래스) 상속해서 커스텀 서블릿을 생성할 수 있다.
 *   커스텀 서블릿을 생성할 수 있다.
 * - HttpServlet상속구조
 *      - Servlet interface
 ...
 * - Tomcat은 Servlet객체를 Singletone패턴으로 관리한다.
 ...
 *      2. 전송박식별로 그에 상응하는 메소드 호출 doGet, doPost등이 있다.
...
public class LifecycleServlet extends HttpServlet {
    ...
    @Override
    public void service(ServletRequest req, ServletResponse res) throws SecurityException{
