...
//    }
     ...
     * - queryString또는 json데이터를 parsing해서 command객체에 담아서 전달할 수도 있다.
     * - 일반 form전송보다는 rset api방식에서 주로 사용한다.
     */
    ...
    @GetMapping("/etc")
    public String etc(@RequestHeader("user-agent")String userAjent,@CookieValue(name = "JSESSIONID", required = true) String jsessionId){
        log.info("userAgent ={}",userAjent);
