...
public class App4 {
    public static void main(String[] args) {
        ...
        // DoubleToIntFunction#applyAsInt(long):int
        // DoubleToLongFunction#applyAsLong(int):long
        ...
        //ToLongBiFunction<T>#applyAsLong(T):long
        //ToDoubleFunction<T>#applyAsDouble(T):double
        //ToDoubleBiFunction<T>#applyAsDouble(T):double
        ...
        List<String> names = Arrays.asList("홍길동", "고길동", "홍진경"); // 변경불가능한 Immutable ArrayList
        String familyName = "홍";
