 ...
 *      (x , y) -> {return x * y; }
 * 4. 우측블럭이 리턴절 한 줄인 경우, {}, return키워드를 생략할 수 있다.
 *      (x, y) -> x * y
...
public class App {
    public static void main(String[] args) {
        ...
        // 곱하기 계산기객체 - 익명클래스
        Calculator MultiflyCalculator = new Calculator() {
            @Override
            public int calc(int a, int b) {
                return a * b;
            }
        };
        result =MultiflyCalculator.calc(10,20);
        System.out.println(result);

        // 람다식을 활용해서 나누기계산기 객체만들기
...
//        Calculator divideCalculator = (a , b) -> a / b;
        ...
        Func.DoubleIntFunc square2 = (n) -> n * n;
