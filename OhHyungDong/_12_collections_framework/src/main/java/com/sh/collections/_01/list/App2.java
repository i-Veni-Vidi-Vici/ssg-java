...
public class App2 {
    public static void main(String[] args) {
        ...
        list.add(new Book(200L, "신사동 가로수길", "신사임당", 35000));
        list.add(new Book(300L, "해시계 파헤치기", "장영실", 40000));

       //2권 추가 (내부적으로 관리되는 배열의 크기를 신경쓰지 않아도 된다.)
        list.add(new Book(400L, "한글2", "세종대왕", 20000));
        list.add(new Book(500L, "잠수왕", "논개", 120000));
...
//        Collections.sort(list, authorAscendingComparator);
        ...
        //sort안에서 한번에 바로
            ...
            //람다식(인터페이스 추상메소드가 하나 일 때 사용 가능) 작성도 가능하다.
