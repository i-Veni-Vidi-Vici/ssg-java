 ...
 *  - junit 단정문, hamcrest, truth 등의 단정문에서 assertj를 가장 많이 사용한다.
 * </pre>
 */
class AppTest {
    App app;
    ...
    @DisplayName("random 메소드는 100에서 200 사이의 난수를 반환해야 한다.")
    @Test
    void test4() {
        Random rnd = new Random();

        int result = app.RandomNumber();
