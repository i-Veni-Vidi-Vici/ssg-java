...
/**
 * ...
 * 나머지파라미터 Rest Parameter : 매개변수부에서 복수개의 값을 처리할수 있는 변수, 맨 마지막에 한번만 사용하기
...
function test3(x, y = 10, z) {
  console.log(x, y, z);
}

test3(10,20,30); // 10 20 30
test3(100); // 100 10 undefined
test3(100, undefined, 300); // 100 10 300
