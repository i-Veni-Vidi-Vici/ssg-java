...
<body>
  ...
  <form action="test" method="get">
    ...
    <br>
    <label>취미 : </label>
    <input type="checkbox" name="hobbies" id="movie" value="movie" checked><label for="movie">영화</label>
    <input type="checkbox" name="hobbies" id="music" value="music" checked><label for="music">음악</label>
    <input type="checkbox" name="hobbies" id="sleep" value="sleep"><label for="sleep">취침</label>
    <br>

    <input type="submit" value="GET 요청">
  </form>
  <a href="test?name=홍길동&age=33&birthday=1999-09-09&gender=M&national=ko&hobbies=movie&hobbies=music">GET 요청</a>
  ...
  <form action="test" method="post">
    ...
    <br>
    <label>성별 : </label>
    <input type="radio" name="gender" id="male2" value="M"  checked><label for="male2">남자</label>
    ...
    <br>
    <label>취미 : </label>
    <input type="checkbox" name="hobbies" id="movie2" value="movie" checked><label for="movie2">영화</label>
    <input type="checkbox" name="hobbies" id="music2" value="music" checked><label for="music2">음악</label>
