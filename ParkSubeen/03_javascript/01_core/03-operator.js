...
// 주의해야 할 비교예제
console.log(`1 == true : ${1 == true}`); // true (true가 1(number)으로 암묵적형변환 처리)
console.log(`100 == true : ${100 == true}`); // false
console.log(`1 === true : ${1 === true}`); // false

console.log(`0 == false : ${0 == false}`); // true (false가 0(number)로 암묵적형변환 처리)
console.log(`0 == '' : ${0 == ""}`); // true (""이 0(number)로 암묵적형변환 처리)
