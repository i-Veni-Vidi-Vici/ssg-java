 ...
 */
let target = 'Javascript jQuery Ajax ssss';

// $& 매칭된 결과를 가리키는 와일드카드
console.log(target.replace(/a/, '<$&>')); // J<a>vascript jQuery Ajax ssss
console.log(target.replace(/a/g, '<$&>')); // J<a>v<a>script jQuery Aj<a>x ssss
console.log(target.replace(/a/gi, '<$&>')); // J<a>v<a>script jQuery <A>j<a>x ssss
console.log();
 ...
 * - $ 문자열의 끝
 */
target = 'Javascript jQuery Ajax ssss xxx';
console.log(target.replace(/j/gi, '<$&>')); // <J>avascript <j>Query A<j>ax ssss xxx
console.log(target.replace(/^j/gi, '<$&>')); // <J>avascript jQuery Ajax ssss xxx
console.log(target.replace(/^j/g, '<$&>')); // Javascript jQuery Ajax ssss xxx
console.log(target.replace(/x/g, '<$&>')); // Javascript jQuery Aja<x> ssss <x><x><x>
console.log(target.replace(/x$/g, '<$&>')); // Javascript jQuery Ajax ssss xx<x>
...
console.log(target.replace(/^j/gim, '<$&>')); // <J>avascript <j>Query Ajax ssss xxx
console.log(target.replace(/x$/gim, '<$&>')); // Javascript jQuery Aja<x> ssss xx<x>
console.log();
...
console.log(target.replace(/[A-z]/g, '<$&>')); // <A><B><C><D><E><F><G><h><i><j><k><l><m><n> 가나다라마바사ㅋㅋㅎㅎㅓㅓㅏㅏ 1234567890 !@#$%<^>&*()
...
console.log(target.replace(/\W/g, "<$&>")); // ABCDEFGhijklmn< ><가><나><다><라><마><바><사><ㅋ><ㅋ><ㅎ><ㅎ><ㅓ><ㅓ><ㅏ><ㅏ>< >1234567890< ><!><@><#><$><%><^><&><*><(><)><->_<=><+>< ><	>< >
console.log(target.replace(/\S/g, "<$&>")); // <A><B><C><D><E><F><G><h><i><j><k><l><m><n> <가><나><다><라><마><바><사><ㅋ><ㅋ><ㅎ><ㅎ><ㅓ><ㅓ><ㅏ><ㅏ> <1><2><3><4><5><6><7><8><9><0> <!><@><#><$><%><^><&><*><(><)><-><_><=><+>
console.log();
