...
/**
 * <pre>
 * 1. 날짜/시간객체(java) -> 특정 형식 문자열    2024/03/27, 2024년 3월 27일, 03/27/2024, 27/03/2024
 * 2. 특정 형식 문자열 -> 날짜/시간객체(java)
 * </pre>
 */
public class App5 {
    public static void main(String[] args) {
        ...
        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy/MM/dd hh:mm:ss"))); // 2024/03/27 02:33:14
        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy/MM/dd(E) HH:mm:ss"))); // 2024/03/27(수) 14:34:02
