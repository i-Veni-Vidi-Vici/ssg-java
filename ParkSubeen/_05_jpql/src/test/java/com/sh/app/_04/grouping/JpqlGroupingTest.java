...
public class JpqlGroupingTest {
    ...
    void test2() {
        ...
        // then
        System.out.println(avg); // 12500.0
    ...
    void test3() {
        ...
        // then
        // null을 포함한 카테고리 수는 현재 11건이다.
        assertThat(dtos).isNotNull().hasSize(11); // 전체 카테고리 수
    }
    ...
    void test4() {
        ...
        dtos.forEach(System.out::println);
        // then
        assertThat(dtos).isNotNull().allMatch((dto) -> dto.getCount() >= 3);
    }
}
