...
public class App3 {
    public static void main(String[] args) {
        // 클래스객체란? 실제 인스턴스 생성을 위해 참조하는 타입별 원형객체(필드/메소드관련 정보를 가지고 있다.)
...
//        Iterator<SubjectType> backendIter = backendSet.iterator();
//        Iterator<SubjectType> frontendIter = frontendSet.iterator();
//        while(backendIter.hasNext()) {
//            SubjectType backendVal = backendIter.next();
//            System.out.println(backendVal.ordinal() + " " + backendVal.name());
//        }
//        while(frontendIter.hasNext()) {
//            SubjectType frontendVal = frontendIter.next();
//            System.out.println(frontendVal.ordinal() + " " + frontendVal.name());
//        }
