...
//        String my name = "신사임당"; // 공백 특수문자는 사용할 수 없다.
        ...
        // 관례적 명명법
        String asfkjdfdfhjdshfjhdsfjhf = "abc"; // 변수명 길이에 제한은 없지만, 적절한 길이로 작성해야 한다.
        System.out.println(asfkjdfdfhjdshfjhdsfjhf);
        int maxAge = 20; // 카멜케이싱
        int MaxAge = 30; // 클래스명을 제외한 변수, 메소드, 필드명은 모두 소문자로 시작하는 암묵적인 관례가 있다.
        // 사용자 이름(subeenPark), 상품코드(productCode), 결혼여부(weddingYn)
        String userName = "홍길동";     // self
        String productCode = "ab567";  // self
        String weddingYn = "N";        // self
        String userName1 = "이순신";
        long productCode1 = 1234124112;
        boolean isMarrid = true;
