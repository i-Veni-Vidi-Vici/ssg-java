...
public class OrderController {
    ...
    // 하나의 url에 여러개의 핸들러 처리를 시도하면 어떤 핸들러를 연결할지 알 수 없어서 서버를 종료함.
//    @PostMapping("/regist")
...
//    }
    ...
    /**
     * 경로변수
     * - @RequestMapping의 path속성 중 {변수명}에 해당하는 부분을 핸들러의 매개변수를 사용할 수 있다.
     * - 경로변수와 매개변수명이 같아야 한다.
...
//    public String findOrderById1(Model model, @PathVariable Long id) {
