...
public class FileUploadController {
    ...
    public String singleFile(
        ...
        // classpath에는 모튤 파일 이름/build/resources/main 하위의 경로를 작성
        ...
        log.debug("dir = {}", dir); // dir = C:/Workspace/spring_workspace/ParkSubeen/02-spring-webmvc/_06_file_upload/build/resources/main/static/upload/single
        ...
        // 3. 저장
        singleFile.transferTo(new File(dir, savedName)); // 실제 서버컴퓨터에 저장(dir 경로에 saveName 이름으로 저장)
    ...
    public String multiFile(
        ...
        log.debug("resource = {}", resource); // resource = class path resource [static/upload/multi]
        String dir = resource.getFile().getAbsolutePath();
        log.debug("dir = {}", dir); // dir = C:/Workspace/spring_workspace/ParkSubeen/02-spring-webmvc/_06_file_upload/build/resources/main/static/upload/multi
        ...
        for(MultipartFile multipartFile : multiFiles) {
            ...
            // 3. 저장
            multipartFile.transferTo(new File(dir, savedName)); // 실제 서버컴퓨터에 저장(dir 경로에 saveName 이름으로 저장)
            // 4. 뷰단에 전달할 데이터 작성
