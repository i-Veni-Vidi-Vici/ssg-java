...
//        prop.setProperty("user", "hongged");
        ...
        try{
            ...
            prop.store(new FileWriter("ParkSubeen/_12_collections_framework/dataSource.properties"), "db configuration");
            prop.storeToXML(new FileOutputStream("ParkSubeen/_12_collections_framework/dataSource.xml"), "db configuration");
        ...
        try {
//            prop2.load(new FileReader("ParkSubeen/_12_collections_framework/dataSource.properties"));
            prop2.loadFromXML(new FileInputStream("ParkSubeen/_12_collections_framework/dataSource.xml"));
