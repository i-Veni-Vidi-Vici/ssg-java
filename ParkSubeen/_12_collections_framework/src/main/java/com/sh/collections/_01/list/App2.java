...
import com.sh.collections._01.list.comparator.TiltleAscending;
...
public class App2 {
    public static void main(String[] args) {
        ...
        list.add(new Book(500L, "장수왕", "논개", 12000));
...
//        Collections.sort(list, new TiltleAscending()); // 제목 오름차순
...
//        });
        ...
        Collections.sort(list, (Book o1, Book o2) -> o1.getAuthor().compareTo(o2.getTitle()));
