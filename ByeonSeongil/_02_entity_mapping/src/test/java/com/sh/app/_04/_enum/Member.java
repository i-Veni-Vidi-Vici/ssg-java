 ...
 *  (mysql의 enum타입을 사용하면, 노출되는 값 name값이지만, 내부적으로는 숫자값으로 관리하기 때문에, 효율성 역시 좋다.)
 * </pre>
 */
@Data
@NoArgsConstructor
...
@Table(name = "tbl_member04") // DB테이블 매핑
@Builder
public class Member {
    @Id
    @Column(name = "member_code")
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "table_sequence_generator")
    private Long code;
