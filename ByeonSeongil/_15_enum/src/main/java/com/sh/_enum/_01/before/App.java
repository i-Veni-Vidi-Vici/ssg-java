...
public class App {
    public static void main(String[] args) {
        // new Memeber(username:String, role:String, gender:String)
        ...
        // 2. 일반 String, int타입으로는 타입안정성을 보장할수 없다.
        System.out.println(createMember("lesss", Member.ADMIN_ROLE, Member.MEMBER_ROLE));
