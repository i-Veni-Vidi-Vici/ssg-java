...
public class EntityLifecycleTest {
    ...
    /**
     *  영속상태의 entity객체를 더이상 영구컨텍스트에서 관리하지 않도록 하는 것 이다.
     */
    @Test
    ...
    /**
     * 모든 영속된 엔티티객체를 영속성 컨텍스트로부터 제게한다.
     */
    @Test
    ...
    /**
     * remove를 호출하면, 단 순히 영속성컨텍스트에서 제거뿐 아니라 db로 delete 요청까지 질의한다.
     *
     *
     */
    @Test
     ...
     * - 동일한 PK를 가진 앤티티객체가 없다면 우선 DB에서 조회후, 변경사항을 적용
    ...
    void test7() {
        ...
        // PK가 10인 Menu객체를 다시 조회후에 menu10객체와 병합 시도한다.
