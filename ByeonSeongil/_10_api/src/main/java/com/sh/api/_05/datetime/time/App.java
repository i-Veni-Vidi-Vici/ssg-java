...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println(localDate1); // 2024-03-07
        System.out.println(localDate2); // 2024-03-07

        // LocalTime 시간
        LocalTime localTime1 = LocalTime.now();
        LocalTime localTime2 = LocalTime.of(14, 15, 30);
        System.out.println(localTime1); // 12:19:04.152685400
        ...
        System.out.println(localDateTime); // 2024-03-27T12:22:35.157261300
        System.out.println(localDateTime2); // 2024-03-04T12:20

        // ZonedDateTime 지역정보 포함
        ZonedDateTime zonedDateTime = ZonedDateTime.now();
        ZoneId zoneId = ZoneId.of("Asia/Seoul");
        ZonedDateTime zonedDateTime2 = ZonedDateTime.of(2024, 3, 27, 12, 10,10,10,zoneId);
        ZonedDateTime zonedDateTime3 = ZonedDateTime.of(localDateTime, ZoneId.of("Asia/Seoul"));
        System.out.println(zonedDateTime); // 2024-03-27T12:26:09.304893700+09:00[Asia/Seoul]
