...
//        Bunny rabbit = bunnyFarm.getRabbit();
//        rabbit.cry();
//
//        Bunny rabbit2 = bunnyFarm2.getRabbit();
//        rabbit2.cry();

        // ? super Bunny
        RabbitFarm<? super Bunny> bunnyFarm3 = new RabbitFarm<>(new Bunny());
        RabbitFarm<? super Bunny> bunnyFarm4 = new RabbitFarm<>(new Rabbit());
        RabbitFarm<? super Bunny> bunnyFarm5 = new RabbitFarm<>(new DrunkenBunny());
