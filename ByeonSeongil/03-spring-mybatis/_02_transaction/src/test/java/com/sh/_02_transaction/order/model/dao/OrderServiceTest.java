...
import com.sh._02_transaction.order.service.OrderService;
...
class OrderServiceTest {
    ...
    void test2() {
        ...
        // spring @Trasactional에서는 org.springframework.dao.DataIntegrityViolationException (unchecked) 예외로 전환해서 던진다.
        assertThatThrownBy(() -> {
            int result = orderService.createOrder(orderDto);
        })
