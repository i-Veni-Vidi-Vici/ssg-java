...
public class DataSourceConfig {
     ...
     * HikariCP는 그중 빠르고 경량화된 라이브러리여서 Springboot에서 기본적으로 사용하고 있다.
     *
     * destroyMethod="close"
     * - 빈이 메모리 헤제될때 호출되는 메서드
    ...
    public HikariDataSource dataSource() {
        ...
        dataSource.setIdleTimeout(60000); // Idle 커넥션풀내에 사용중이 아닌 커넥션객체를 가리킴. Idle최대 대기시간
    ...
    /**
     * @Bean 메서드의 매개변수 선언으로 의존주입처리할 수 있다.
     * @return
     * @throws Exception
     */
    @Bean
    public SqlSessionFactory sqlSessionFactory(HikariDataSource dataSource) throws Exception {
        ...
        // 추가설정
        configuration.setMapUnderscoreToCamelCase(true); // 컬럼명 - 프로퍼티 자동매칭
        ...
        // 별칭 등록
//        sqlSessionFactoryBean.addTypeAliases(MenuDto.class); // 풀네임 대신 별칭으로 접근 가능
