...
public class RequestParameterServlet extends HttpServlet {
     ...
     * - http://localhost:8080/03_request_parameter/test?name=홍길동&age=33&married=true 요청에서
     * - name=홍길동&age=33&married=true Query String부분은 request객체안에서 HashMap으로 관리된다.
