...
public class Global404Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /*
            jakarta.servlet.forward.request_uri = /08_error_page/dasdfasdfasdfasdf
            jakarta.servlet.forward.context_path = /08_error_page
            jakarta.servlet.forward.servlet_path = /dasdfasdfasdfasdf
            jakarta.servlet.forward.mapping = org.apache.catalina.core.ApplicationMapping$MappingImpl@2bec701c
            jakarta.servlet.error.message = 요청된 리소스 [/08_error_page/dasdfasdfasdfasdf]은(는) 가용하지 않습니다.
            jakarta.servlet.error.servlet_name = default
            jakarta.servlet.error.request_uri = /08_error_page/dasdfasdfasdfasdf
