...
koo();  
console.log(foo);   //[Function: foo] { num: 777 } (속성으로 num:777이 추가됨을 확인할수 있음)
 ...
 * - 클로저는 내부적으로 num을 가지고 있지 않으며 자신이 속한 렉시컬 환경 스코프에 대한 참조를 유지한다
 * 
 ...
 * - 화살표 함수는 this를 사용할 수 없다, 부모스코프의 this를 가져와 사용함
