 ...
 */
public class App {
    public static final String ROOT = "KuMinsang/_14_io/"; // 프로젝트루트 (상대경로)
    public static void main(String[] args) {
        File file = new File(ROOT + "test.txt");
        System.out.println(file); // KuMinsang\_14_io\test.txt 파일경로로 toString 오버라이드 되어 있음.
        ...
        try {
            ...
            System.out.println(file.getAbsolutePath()); // C:\Workspaces\java_workspace\KuMinsang\_14_io\test.txt
        } catch (IOException e) {
            e.printStackTrace();
        }
