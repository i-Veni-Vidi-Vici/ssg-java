...
public class MenuController {
    ...
    public String registMenu(Model model) {
        ...
        return "mappingResult"; // src/main/resources/templates/mappingResult.html을 찾아 응답 작성    }
    }
...
//    @RequestMapping(value = "/menu/modify", method = RequestMethod.GET) // value, path 둘 다 가능. value가 path의 alias
    @GetMapping("/menu/modify") // 36줄과 동일한 기능
...
//    @RequestMapping(path = "/menu/modify", method = RequestMethod.POST)
    @PostMapping("/menu/modify") // 46줄과 동일한 기능
