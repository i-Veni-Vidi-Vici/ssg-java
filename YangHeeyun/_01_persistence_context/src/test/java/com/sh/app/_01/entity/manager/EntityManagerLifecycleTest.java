...
public class EntityManagerLifecycleTest {
    ...
    private static EntityManagerFactory entityManagerFactory; // 보통 static으로 만든다
    // request-scope: 웹요청마다 1개씩 생성(non-thread-safe)
    private EntityManager entityManager;

    @BeforeAll
    static void beforeAll(){
        // jpa설정정보를 읽어서 EntityManagerFacotry를 생성
    ...
    // test하나가 하나의 웹 요청이라 생각하기
    @Test
    @DisplayName("EntityManagerFactory는 공유, EntityManager는 각자 사용")
    void test1() {
        System.out.println(entityManagerFactory.hashCode()); // 1689129053
        System.out.println(entityManager.hashCode()); // 279023166
    }
    ...
    void test2() {
        System.out.println(entityManagerFactory.hashCode()); // 1689129053
        System.out.println(entityManager.hashCode()); // 1312250810
    }
}
