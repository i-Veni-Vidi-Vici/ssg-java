...
public class JpqlJoinTest {
        ...
        /*
            ...
            left join
                tbl_category c1_0
                    on m1_0.category_code=c1_0.category_code
         */
        System.out.println(menus.size()); // 80
        menus.forEach(System.out::println);
        // then
        assertThat(menus).isNotNull();
    }
        ...
        /*
            ...
            Hibernate:
                ...
                where
                    c1_0.category_code=?
         */
        menus.forEach(System.out::println); // MenuEntity#toString() - Category#toString() 여기서 category를 select함
        // then
        assertThat(menus).isNotNull();
    }

    @Test
    @DisplayName("엔티티 연관관계가 있을때 fetch join 처리") // N+1 이슈 해결
    void test6() {
        // given
        String jpql = """
                select
    ...
    /**
     * Aggregate 너머의 엔티티 참조하기 (Menu Entity를 조회하면서 컬럼에 없는 CategoryName을 알고 싶을때)
