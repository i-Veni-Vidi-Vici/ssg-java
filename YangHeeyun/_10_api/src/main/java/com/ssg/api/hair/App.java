...
public class App {
    public static void main(String[] args) {
        ...
        for(int i=0;i<arr.length;i++){
            ...
            LocalDate reservation_date = LocalDate.parse(userData[6]);
            LocalTime reservation_time = LocalTime.parse(userData[7], DateTimeFormatter.ofPattern("H:mm"));
            LocalDateTime createdAt = LocalDateTime.parse(userData[8]);

            users[i] = new User(id,first_name,last_name,email,gender,birthday,reservation_date,reservation_time,createdAt);
