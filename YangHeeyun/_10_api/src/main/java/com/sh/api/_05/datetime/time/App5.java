...
public class App5 {
    public static void main(String[] args) {
        ...
        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy/MM/dd hh:mm:ss"))); // 2024/04/10 10:30:52
        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy/MM/dd(E) HH:mm:ss"))); //2024/04/10(수) 22:30:52
...
//        LocalDate date1 = LocalDate.parse(data1, DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        LocalDate date1 = LocalDate.parse(data1); // 날짜표기 표준형식을 썼을때만 생략가능함
