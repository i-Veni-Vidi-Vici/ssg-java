...
4. Entity Header : 본문의 응답리소스에 대한 상세정보 (리소스 크기, 타입...)

헤더 내용
* accept : 요청을 보낼 때 서버에게 요청할 응답 타입 명시 (타입 ex. Xml, JSON, 이미지, text/html 같은 것을 MIME라고 한다)
