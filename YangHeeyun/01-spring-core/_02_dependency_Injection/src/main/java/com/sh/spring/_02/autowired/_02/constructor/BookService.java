...
public class BookService {
    ...
    private final BookDao bookDao; // bookService는 bookDao에 의존한다. findAll(), findById()는 bookDao가 null이면 성립할 수 없기때문

//    @Autowired // 생성자가 1개라 생략할 수 있다.
    private BookService(BookDao bookDao){ // bookDao가 bookService보다 먼저 만들어진다
