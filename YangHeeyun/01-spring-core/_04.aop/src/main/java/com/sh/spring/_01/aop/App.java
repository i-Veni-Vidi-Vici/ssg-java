...
/**
 * AOP가 사용하는 Proxy객체(aspect advice가 들어올 공간을 만들기 위해서 사용)
...
public class App {
    public static void main(String[] args) {
        ...
        // AOP를 위해(어드바이스 삽입) 실제 MemberService객체가 아닌 MemberService Proxy객체가(실제를 대신하는 대체자) 빈으로 관리된다.
        ...
        // MemberService#Member() -> Member.DgetMember();
    }
}
