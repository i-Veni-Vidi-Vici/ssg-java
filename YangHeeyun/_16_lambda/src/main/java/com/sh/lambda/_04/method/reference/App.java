...
//        Supplier<Person> supplier1 = () -> new Person();
        ...
        Function<Long, Person> personFunction1 = Person::new;
        System.out.println(personFunction1.apply(1L));

        // String, int 생성자 호출
        BiFunction<String, Integer, Person> personBiFunction = Person::new;
        System.out.println(personBiFunction.apply("홍길동",22));


        // long, String, int생성자 호출
