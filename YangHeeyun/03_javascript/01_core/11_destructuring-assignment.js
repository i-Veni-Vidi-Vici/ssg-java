...
// const[a,b,c,d] = arr; // 가 나 다 undefined 해당인덱스의 값이 존재하지 않으면, undefined를 반환
const [a,b,c,d = 'ㅋㅋㅋ'] = arr; // 가 나 다 ㅋㅋㅋ
console.log(a,b,c,d);
...
// console.log(result); // [ 50, 10, 600, 1.5, 10 ]
