 ...
 * >= 좌항이 우항보다 크거나 작은가? ge greater than or equal to
...
public class ComparisonOperatorApp {
    public static void main(String[] args) {
        ...
        // 예외적으로  int 하위의 타입(byte,short,char)은 int로 형변환 후 연산한다.
        char e = 'a'; // 97
        char f = 'A'; // 65
        ...
        System.out.println('a' > 'A'); // true 내부적으로는 정수 변환 후 처리된다.

        // 논리 비교 - 동등비교만 가능하다. 크기비교는 불가능
        boolean bool1 = true;
        boolean bool2 = false;
