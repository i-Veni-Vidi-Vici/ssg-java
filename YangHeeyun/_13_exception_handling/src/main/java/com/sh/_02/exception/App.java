...
public class App {
    public static void main(String[] args) {
        ...
        try{
            System.out.println(10/0); // 0으로 나누면 ArithmeticExceotion
        ...
        try{
            ...
            System.out.println("null에 대해 field/method를 참조할 수 없습니다.");
        }
        ...
        try{
            ...
            // 오류가 발생했을때 실행할 코드 - catch절이 실행되면, 예외처리되고 정상흐름으로 복구됨
