...
public class VariableApp {
    ...
    public static void main(String[] args){
        ...
        System.out.println("2번 고객에게 " + 200 +"포인트를 지급합니다.");
        System.out.println("3번 고객에게 " + 200 +"포인트를 지급합니다.");
        System.out.println();
        ...
        // 프로그래밍에서 =는 대입연산자 - 우항의 값을 좌항의 공간에 대입하라! 연산자 우선순위 낮다.
        price = price +10000; // 장바구니에 상품 추가
        System.out.println("총액은 " + price + "원 입니다."); // price = 10,000
        price = price +20000; // 장바구니에 상품 추가
        System.out.println("총액은 " + price + "원 입니다."); // price = 30,000
    }
}
