...
public class Team2PlayerTest {
        ...
        /*
            ...
            Hibernate:
                ...
                where
                    p1_0.team_id=?
         */
        System.out.println(team2); // Team(id=1, name=우당탕탕 야구단, players=[Player(id=2, name=신사임당), Player(id=1, name=홍길동)])
    ...
    void test4() {
        ...
        assertThatNoException().isThrownBy(() -> {
            // Team생성자 안에서 변경가능한 Set으로 교체해서 더이상 UnsupportedOperationException 예외가 발생하지 않는다.
