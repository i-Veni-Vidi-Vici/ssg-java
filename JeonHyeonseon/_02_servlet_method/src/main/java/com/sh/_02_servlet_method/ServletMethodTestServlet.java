...
@WebServlet(name="ServletMethodTestServlet", value="/test") // 만약 값 하나만 속성명없이 존재한다면, value속성값이다.
public class ServletMethodTestServlet extends HttpServlet {
     ...
     *      - HttpServletRequest : 웹요청에 관련된 추상체. 실제 생성객체는 이 인터페이스를 구현한다.
     * - ServletResponse : 응답준비와 관련된 정보를 가진 객체
     *      - HttpServletResponse : 웹응답에 관련된 추상체. 실제 생성객체는 이 인터페이스를 구현한다.
     *
     * @param req
     * @param res
