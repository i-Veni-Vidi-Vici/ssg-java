...
const hi = function(name){
    ...
    // arguments 숨은 참조변수 : 호출시 전달한 모든 매개인자를 배열로 가지고 있다.
    // 유효성검사용으로 사용가능하다.
...
/**
 * ...
 * 나머지파라미터 Rest Parameter : 매개변수부에서 복수개의 값을 처리할 수 있는 변수, 맨마지막에 한 번만 사용하기
...
test3(100, null, 200); // 100 null(값없음을 의미하기 때문에 null로 출력됨) 20
 ...
 * 
 * 함수형프로그래밍에서 이 함수는 일급객체로 다루는 것이 중요하다. 
...
// 경찰차 factory를 지어서(함수 만들기) 10대 출력하세요.
const policecarFactory = carFactoryBuilder2('🚔');
policecarFactory3(10);