...
public class App2 {
    public static void main(String[] args) {
        ...
        // equals/hashCode 비교후, equals결과가 true, hashCode가 동일할 때 같은 객체로 간주한다.
        System.out.println(book5.equals(book6)); // true
        System.out.println(book5.hashCode() == book6.hashCode());  // true가 나오고 싶다면 equals#hashCode는 오버라이드를 해야한다.

        System.out.println(bookSet);
        System.out.println(bookSet.size());  // 요소의 개수 5
