 ...
 * <pre>
 * Properties 클래스
 * - 레거시클래스임에도 현재까지 많이 사용되는 맵계열 클래스이다.
...
public class App4 {
    public static void main(String[] args) {
        ...
        try {
            ...
            prop.store(new FileWriter("JeonHyeonseon/_12_collections_framework/dataSource.properties"), "db configuration");
            prop.storeToXML(new FileOutputStream("JeonHyeonseon/_12_collections_framework/dataSource.xml"), "db configuration");
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
//            prop2.load(new FileReader("JeonHyeonseon/_12_collections_framework/dataSource.properties"));
            prop2.loadFromXML(new FileInputStream("JeonHyeonseon/_12_collections_framework/dataSource.xml"));
