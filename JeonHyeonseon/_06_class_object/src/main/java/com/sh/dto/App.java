 ...
 *  - 데이터 전송 객체
 *  - 클래스가 가진 행위가 아니라 데이터를 보관하고 전달하기 위한 목적으로 클래스 설게할 수 있다.
...
public class App {
    public static void main(String[] args) {
        MemberDto memberDto = new MemberDto(); // 객체 생성 => int 변수처럼 하나를 더 만드는 것
        // 객체에 값 작성하기
        memberDto.setId(1);
        ...
        memberDto2.setId(10);
        memberDto2.setName("전현선");
        memberDto2.setAge(24);
        memberDto2.setGender('여');
        memberDto2.setHeight(160);
        memberDto2.setWeight(100);
