...
//        App1 app = new App1();
        com.sh._package.App1 app = new com.sh._package.App1(); // 현재 패키지의 App1
        app.test();
...
//        App1.test2();
        ...
        // method패키지의 App1클래스의 a, b, c 메소드를 호출
        // 동일한 이름의 클래스를 가져다 쓰는 경우, import문이 아닌 풀네임으로 작성해야 한다.
        com.sh.method.App1 app1 = new com.sh.method.App1(); // method패키지의 App1
        app1.a();
        app1.b();
        app1.c();
