...
public class RoleEntityTest {
    ...
    void test3() {
        ...
        /*
            ...
            where
                r1_0.id=?
        */
        System.out.println(role2.getName()); // 매니져. role2.toString() 호출 -> permissions.toString() 호출
    ...
    void test4() {
        ...
        try {
            ...
            role.setChangePermissions(newPermissions);
            transaction.commit();
            /*
               // tbl_role_permission_0301테이블에서 ROLE_MANAGER관련 행을 모두 삭제 후에 다시 insert한다.
               Hibernate:
                delete
                    from
                        tbl_role_permission_0301
