...
public class MembershipCard2UserTest {
    ...
    void test2() {
        ...
        this.entityManager.flush(); // commit 대신 명시적으로 쿼리를 확인하기 위해서 작성함
        /*
        Hibernate:
            insert
            into
        ...
        // then
        // 등록이 잘 됐는지 확인
        this.entityManager.clear(); // 영속석 컨텍스트 안의 영속객체 모두 제거(준영속처리)
    ...
    void test3() {
        ...
        assertThat(membershipCard2).isNotNull();
        assertThat(membershipCard2.getOwner()).isNull(); // user가 null인 경우를 확인하고 있기 때문에 owner는 null이어야 한다.
    }
}
