 ...
 * <pre>
 * 상속구조의 객체지향 설계
 * - 부모의 필드/메소드를 자식클래스가 선언없이 사용가능하다.
...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println(computer1.getInfo()); // Computer[null, 0, 0, null]

        Computer computer2 = new Computer("com1234", "삼성", "갤럭시북", 2_000_000, LocalDate.now(),
                                        "i9", 32, 1000, "windows11");
        System.out.println(computer2.getInfo()); // Computer[i9, 32, 1000, windows11]

        Tv tv1 = new Tv();
        System.out.println(tv1.getInfo());
        Tv tv2 = new Tv("tv4567", "엘지", "엘지롤러블TV", 5_000_000, LocalDate.now(), "8k", 100);
