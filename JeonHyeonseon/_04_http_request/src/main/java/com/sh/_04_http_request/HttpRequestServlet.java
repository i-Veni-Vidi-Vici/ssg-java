 ...
 *  2. Request Header : 응답할 리소스나 요청클라이언트에 대한 상세정보
 *  3. Response Header : 응답위치/서버 자체와 같은 응답관련 상세정보
 *  4. Entity Header : 본문의 응답리소스에 대한 상세정보 (리소스크기, 타입 등을 가지고 있다.)
 *
 * - 헤더내용
...
public class HttpRequestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        while(headerNames.hasMoreElements()) { // while문을 통해서 다음 요소가 있니?
            String headerName = headerNames.nextElement(); // 있으면 다음 요소 보내줘.
