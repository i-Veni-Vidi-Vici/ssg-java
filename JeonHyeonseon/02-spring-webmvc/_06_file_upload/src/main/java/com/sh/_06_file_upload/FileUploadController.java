...
public class FileUploadController {
    ...
    public String singleFile(
        ...
        String savedName = UUID.randomUUID() + ext; // abds-1234-2345-63er.png
        // 3. 저장
        singleFile.transferTo(new File(dir, savedName)); // 실제 서버컴퓨터에 저장하는 방법
    ...
    public String multiFile(
        ...
        for(MultipartFile multipartFile : multiFiles) {
            ...
            String savedName = UUID.randomUUID() + ext; // abds-1234-2345-63er.png
            // 3. 저장
            multipartFile.transferTo(new File(dir, savedName)); // 실제 서버컴퓨터에 저장하는 방법
            // 4. 뷰단에 전달할 데이터를 작성
