...
public class LoggingAspect {
     ...
     *  - *는 모든 글자를 의미하는 와일드카드
     *  - *Service, *Service.get* 으로 사용 가능하다.
...
//    @After("pointcut()")
    ...
    /**
     * 예외처리가 아닌 예외가 발생했을 경우의 후처리 작업을 작성한다.
     * @param exception
     */
