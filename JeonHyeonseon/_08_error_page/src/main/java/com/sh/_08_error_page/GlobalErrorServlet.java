...
public class GlobalErrorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        jakarta.servlet.forward.mapping = org.apache.catalina.core.ApplicationMapping$MappingImpl@468038d8
        jakarta.servlet.error.message = ㅋㅋㅋㅋㅋ에러 났엉^^ㅋㅋㅋㅋ
        jakarta.servlet.error.exception = java.lang.RuntimeException: ㅋㅋㅋㅋㅋ에러 났엉^^ㅋㅋㅋㅋ
        ...
        out.println("""
            ...
            <html>
                ...
                <body>
                    <h1 style="text-align: center; font-size: 300px; margin: 100px 0;">홀리몰리</h1>
