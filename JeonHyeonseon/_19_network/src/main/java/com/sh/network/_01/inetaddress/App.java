 ...
 *  - 도메인을 입력하면, 그에 상응하는 ip주소를 DNS예 먼저 질의후 반환한다.
 * </pre>
 */
public class App {
    public static void main(String[] args) {
        try {
            ...
            System.out.println(google.getHostAddress()); // 172.217.25.164
            ...
            System.out.println(localHost.getHostAddress()); // 192.168.0.14
