...
//        Member honggd = new Member("honggd", Member.MEMBER_ROLE, Member.MEMBER_ROLE); // 실수가 티나지 않는다
        ...
        System.out.println(Member.MEMBER_ROLE.equals(Member.GENDER_MALE));  // true, 실수하기 좋음
        // 2. 일반 String, int타입으로는 타입 안정성을 보장할 수 없다.(적절한 타입인지 구별할 수 없다)
