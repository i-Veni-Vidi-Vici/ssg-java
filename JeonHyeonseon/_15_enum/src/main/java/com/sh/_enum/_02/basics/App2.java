...
public class App2 {
    public static void main(String[] args) {
        // name() : 상수값을 문자열로 반환. toString()과 비슷하다.
        ...
        System.out.println(SubjectType.JAVA.ordinal()); // 0, 인덱스가 0이다라는 의미
        ...
        String subject = "JAVA";
        SubjectType java = SubjectType.valueOf(subject); // static 메소드 제공
        System.out.println(java instanceof SubjectType); // true, enum타입이다.
        System.out.println();
