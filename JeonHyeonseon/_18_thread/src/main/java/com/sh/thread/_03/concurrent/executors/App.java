...
/**
 * <pre>
 * Executors API는 쓰레드의 생성, 종료 등의 작업을 위임에서 처리하는 기능이다.
 * 즉, 사용자는 실제 할일(Runnable구현 클래스)만 작성하면 된다는 의미이다.
 *
...
public class App {
    public static void main(String[] args) {
        ExecutorService executorService = Executors.newFixedThreadPool(3);// 쓰레드 개수 지정 : 36
...
//                };
        ...
        executorService.submit(function.apply(10, 20)); // 순서는 보장하지 못함, 엇갈릴 수 있다.
//        executorService.submit(() -> System.out.println(Thread.currentThread().getName() + " " + 10 + " + " + 20 + " = " + (10 + 20)));
        ...
        executorService.shutdown(); // 할일 다 하면 끝나도록 해줌
    }
}
