...
const user = {
    ...
    "user-car" : '소나타',
    "favorite food" : '물회'
}; // 코드블럭(if, for, function등)이 아니므로 ;로 종결처리 필요
console.log(user);
...
console.log(Object.values(menu)); // [ '순대국', 10000, [ '안매움', '보통', '매움' ] ]
...
const student = {
    name : "홍길동",
    age : 33, // 마지막 컴마는 문법적 오류를 유발하지 않는다.
};
...
// student객체에 school 속성이 없으면, school : 'SSG학교'를 추가하는 코드
// (조건식) && (참일 때 실행문)
// (조건식) || (거짓일 때 실행문)
 ...
 *  - enumerable : true(for..in문에서 반복접근가능)/false 
