...
public class MenuQueryMethodTest {
    ...
    void test1() {
        ...
        String menuName = "밥";
        // when
//        List<Menu> menus = menuRepository.findByMenuNameLike("%" + menuName + "%" ); // %로 감싸서 전달해야 한다.
        List<Menu> menus = menuRepository.findByMenuNameContaining(menuName); // 이때는 자동으로 %를 붙혀준다.
