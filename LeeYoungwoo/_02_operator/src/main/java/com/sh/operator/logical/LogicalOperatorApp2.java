...
//        System.out.println(false && num++ > 0); // and 연산자 -> 좌항이 false이기 때문에 우항검사 안함 num = 10
        System.out.println(num);

        int k = 20;
        System.out.println(true || k++ > 20); // or 연산자 -> 좌항이 true이기 때문에 우항검사 안함 k = 20
//        System.out.println(false || k++ > 20); // 21
