...
//        MemberRole memberRole = new MemberRole(); // enum은 new MemberRole() 불가능
...
//        printRole(Gender.M); // 컴파일 오류
        ...
        Subject subject2 = new Subject(SubjectType.MYSQL, "대표 DBMS", 40);
        Subject subject3 = new Subject(SubjectType.HTML, "웹언어", 40);
