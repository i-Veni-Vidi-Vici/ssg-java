package com.sh.lambda._04.method.rederence;

import com.sh.lambda._02.anonymous._class.Func;
...
//        Consumer<String> consumer = (str) -> System.out.println(str);
        Consumer<String> consumer = System.out::println; // 단 전달받은 str을 가공하지 않고 그대로 전달할 때만 사용가능
        consumer.accept("홍길동");
...
//        BiFunction<String , Integer, Person> personBiFunction = (name, age) -> new Person(name, age);
        ...
        System.out.println(personBiFunction.apply("홍길동", 27));

        // long, String, int 생성자 호출 (JDK는 인자 3개받는건 없음)
