...
public class Survey2InquiryTest {
        ...
        /*
            ...
            Hibernate:
                alter table tbl_question
                   add constraint FKbxvljn5jcykjeehpox2f75gtr
    ...
    void test3() {
        ...
        this.entityManager.flush();
        /*
        - survey_id, question_idx를 모두 제거하는 update문 4건
        - survey_id, question_idx를 모두 재지정하는 update문 3건
         */
        Inquiry inquiry = new Inquiry(null, "당신이 제일 좋아하는 책은?");
