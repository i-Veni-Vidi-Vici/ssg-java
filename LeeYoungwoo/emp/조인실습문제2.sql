...
select EMP_ID 사원번호,
       ...
       QUIT_YN 퇴직여부
from employee
where QUIT_YN = 'N' and right(PHONE, 1) = 2
...
where e.QUIT_YN = 'N' and j.JOB_NAME = '대리';
...
where not isnull(e1.MANAGER_ID);