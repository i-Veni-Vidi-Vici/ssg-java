...
-- 데이터 무결성 보장을 목적으로 한다.
-- 데이터 입력/수정시에 자동으로 제약조건에 부합하는지 검사

# 구분
-- 1. NOT NULL : null을 허용하지 않는다.
-- 2. UNQUE : 중복된 값을 허용하지 않는다.
-- 3. PRIMARY KEY : 기본키, 고유식별컬럼 (NOT NULL, UNQUE)
...
where CONSTRAINT_SCHEMA = 'empdb' and TABLE_NAME = 'employee';
-- ddl을 통해 확인
...
values
    (1, 'honggd', '1234', '홍길동', '남', '01012341234', 'hongdg@naver.com'),
...
create table if not exists user_primarykey (
    ...
    phone char(11) not null ,
    email varchar(100),
    primary key(user_no), -- PRIMARY KEY 이름을 지정할 필요없음
...
values
#     (1, 'honggd', '1234', '홍길동', '남', '01012341234', 'hongdg@naver.com');
#     (null, 'honggd', '1234', '홍길동', '남', '01012341234', 'hongdg@naver.com');
    (3, 'leess', '1234', '이순신', '남', '01012341234', 'leess@naver.com');
...
#     prod_no =300
#     and user_id = 'leess'
#     and order_date = '2024-04-23 11:19:59';
    (prod_no, user_id, order_date) = (300, 'leess','2024-04-23 11:19:59');
...
values
    (1, 'honggd', '1234', '홍길동', 10, '남', '01012341234', 'hongdg@naver.com'),
...
# 참조하는 자식행이 있는경우 부모컬럼은 삭제/변경할 수 없다.
...
-- 부모컬럼 PRIMARY KEY (`category_code`)
-- 자기참조 (같은테이블 다른 컬럼을 참조, 상위 카테고리의 category_code를 하위 카테고리에서 ref_category_code로 참조)
...
create table if not exists user_check (
    ...
    phone char(11) not null ,
    email varchar(100),
    constraint ck_user_check_gender check (binary gender in ('M', 'F')), -- 대소문자 구분이 필요한 경우 binary 사용
...
values
    (1, 'honggd', '1234', '홍길동', 'M', 20, '01012341234', 'hongdg@naver.com'),
...
insert into user_check
values
    (4, 'nondog', '1234', '이순신', 'F', -1, '01012341234', 'nondog@naver.com'); -- [HY000][3819] Check constraint 'ck_user_check_age' is violated
