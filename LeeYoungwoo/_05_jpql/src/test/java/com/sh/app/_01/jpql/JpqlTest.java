...
public class JpqlTest {
    ...
    void test2() {
        // given
        // select절, where조건절에서도 table이 아닌 entity 기준으로 조회한다.(필드명 적어준다)
    ...
    void test3() {
        ...
        // <>안에 타입을 검사해주지 못해서 빨간줄이 안뜨고 돌리면 에러가 난다.
        List<Menu> menus = query.getResultList();
        /*
    ...
    void test4() {
        ...
        // when
        TypedQuery<Long> query = this.entityManager.createQuery(jqpl, Long.class);
        ...
        assertThat(categoryCodes.size()).isEqualTo(temp.size()); // [null, 4, 5, 6, 8, 9, 10, 11, 12]
    }
}
