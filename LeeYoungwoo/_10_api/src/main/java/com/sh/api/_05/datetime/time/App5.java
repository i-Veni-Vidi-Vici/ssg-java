...
/**
 * <pre>
 * 1. 날짜/시간객체 -> 특정 형식 문자열 2024/03/27 2024월 3월 27일...
...
public class App5 {
    public static void main(String[] args) {
        ...
        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy/MM/dd hh:mm:ss"))); // 2024/03/27 02:34:51
        System.out.println(now.format(DateTimeFormatter.ofPattern("yyyy/MM/dd(E) HH:mm:ss"))); // 2024/03/27(수) 14:34:51
