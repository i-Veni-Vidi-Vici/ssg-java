 ...
 *
 * @Transactional 메소드안에서 던져진 예외가 RuntimeException의 후손인 경우만, rollback 처리한다. (기본값)
...
@Transactional(
        ...
        // 여기까진 기본값이라 생략가능
        rollbackFor = Exception.class // 요건 써줘야한다.
)
@Service
...
public class OrderService {
     ...
     */
    private final OrderMapper orderMapper; // 의존주입(final이기 때문에 무조건 orderMapper 하나를 받아야 한다. -> 반드시 빈이여야됨)
