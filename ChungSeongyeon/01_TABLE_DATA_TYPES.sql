...
-- 대소문자를 구분하지 않는 SQL 특성 상 snake_case방식으로 단어를 연결해 사용한다.
...
values (
        ...
        1234.5678901234567890 -- 1234.5678 0000 0000 0000 0000
       );
...
--          지역대 정보를 제거하고 UTC(세계협정시)로 관리. 불러올 때는 지역대 정보를 적용해서 보여줌.
--          국제화가 필요한 앱에 적합하다.
-- YEAR YYYY 형식으로 관리
