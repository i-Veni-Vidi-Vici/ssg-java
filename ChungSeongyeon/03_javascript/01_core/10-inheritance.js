...
/**
 * class 문법
 * - 생성자함수 안에서 부모생성자(super()) 호출가능
 * - 메소드는 자동으로 prototype에 작성됨.
 * - 메소드오버라이드(super키워드 사용가능)
 */
class FamilyCar extends Car {
    ...
    /**
     * 자동으로 FamilyCar.prototype 객체에 메소드등록
     */
    tour(){
        console.log(`패밀리카 "${this.name}"이 ${this.nums}명을 싣고 여행간다~`);
    }

    run(){
        super.run(); // 부모메소드 호출가능
        console.log("WooooooooooooooooooooooooooooooooooooooWWWW~ 🚐");
    }
