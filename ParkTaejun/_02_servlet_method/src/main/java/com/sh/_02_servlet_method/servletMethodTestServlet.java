 ...
 *      - HttpServletResponse : 웹응답에 관련된 추상체  : 웹응답에 관련된 추상체. 실제 생성객체는 이 인터페이스를 구현
 */
//@WebServlet(name = "ServletMethodTestServlet ", value = "/test") // 만약 속성명 없이 값하나만 존재한다면 , value 속성 값이다.
@WebServlet("/test") // 만약 속성명 없이 값하나만 존재한다면 , value 속성 값이다.
