...
@PropertySource("/product-info.properties") // src/main.resource 하위경로 적으면 됨
public class ContextConfiguration {
    ...
    @Bean
    public Product water(@Value("${shoppingCart.water.waterName}")String waterName,
                         @Value("${shoppingCart.water.waterPrice}") int waterPrice,
                         @Value("${shoppingCart.water.waterCapacity}") int waterCapacity)
