...
//        Map map2 = new HashMap();
        Map<String, Integer> map = new HashMap<>(); // 타입 2개를 건네야 함.
...
//        map.put(50, "이순신");
        ...
        // 중복된 key로 저장
//        map.put("홍길동", 33); // set 처럼 중복여부 T/F로 확인안하고 중복값은 새로운 값으로 덮어써짐.
        Integer removed = map.put("홍길동", 33);
        System.out.println("removed: " + removed);

        // toString
        System.out.println(map); // {신사임당=40, 홍길동=23} ===> {Key=Value, Key=Value} 형식
