...
public class App {
    public static void main(String[] args) {
        ...
        // 설정
        configuration.setMapUnderscoreToCamelCase(true); // 기본 값은 false이다.
        ...
        System.out.println(menuDto); // MenuDto{menuCode=1, menuName='열무김치라떼', menuPrice=4500, categoryCode=8, orderableStatus='Y'}
        ...
        System.out.println(now); // 2024-05-08T11:43:19
