...
//        generateMember();
        ...
        member.age = 40;
        member.gender = '여';
        member.hobbies = new String[]{"스퀴시", "클라이밍"};

        System.out.println(member.id);                  // uesr02
        ...
        System.out.println(Arrays.toString(member.hobbies)); // [스퀴시, 클라이밍]
