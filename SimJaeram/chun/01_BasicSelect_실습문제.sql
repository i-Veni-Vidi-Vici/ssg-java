...
select
    concat(DEPARTMENT_NAME, '국어국문학과의 정원은 ', CAPACITY, '명 입니다.') as "학과별 정원"
from
    tb_department;
...
-- 그럼춘기술대학교 총장의 이름을 알아낼 수 있는 SQL 문장을 작성하시오.
select
    *
from
    tb_professor
where
    PROFESSOR_NAME = '임해정'; -- 총장님은 소속학과가 없으므로 department_no가 null
