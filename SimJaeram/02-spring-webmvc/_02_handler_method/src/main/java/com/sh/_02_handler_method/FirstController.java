...
//    }
     ...
     * - queryString 또는 json데이터를 parsing해서 command객체에 담아서 전달할 수 도 있다.
    ...
    public void requestBody2(@RequestBody String queryString){
        log.debug("queryString = {}", queryString); // name=%EC%82%BC%EA%B0%81%EA%B9%80%EB%B0%A5&price=3000&categoryCode=1&orderableStatus=Y
    }

    @GetMapping("/etc")
    public String etc(@RequestHeader("user-agent") String userAgent, @CookieValue(name = "JSESSIONID", required = false) String jSessionId){
