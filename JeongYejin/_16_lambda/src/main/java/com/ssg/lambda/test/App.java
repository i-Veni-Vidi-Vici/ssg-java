...
public class App {
    ...
    private void test3() {
        ...
        Consumer<Double> consumer = (Double d) -> System.out.println((int)(d * 1350));
        Double dollar = sc.nextDouble();
        consumer.accept(dollar);
    }
    ...
    private void test4() {
        Scanner sc = new Scanner(System.in);
        Function<Double, Integer> function = (Double d) -> {
            return (int)(d * 1350);
        };
        Double dollar = sc.nextDouble();
        System.out.println(function.apply(dollar));
    }
