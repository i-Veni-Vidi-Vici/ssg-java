 ...
 * <code>(SELECT {프로젝션 대상} FROM 엔티티)</code>
 *
 * 프로젝션 대상은 4가지 방식이 있다.
 * 1. 엔티티 프로젝션
 *    원하는 객체를 바로 조회할 수 있다.
...
//                .allMatch((menuVo) -> menuVo instanceof MenuVo)
    ...
    void test3() {
        ...
        assertThat(categoryNames).isNotNull()
                .allMatch((categoryName) -> categoryName != null);
    }
    ...
    void test3_2() {
        ...
        String jpql = """
                ...
                """;
        // when
        // 그룹함수 결과는 기본형이 아닌 wrapper타입으로 관리하자 - null값 가능성
        // 정수 반환될 때 Long아니면 Double형이다
    ...
    /**
     * 반환된 DTO객체는 영속되지 않는다. (Entity객체가 아니기 때문)
     */
    @Test
    ...
    void test4() {
        ...
        // DTO 수정은 영속성컨텍스트 또는 DB에 어떤 영향도 줄 수 없다.
