...
// length 속성은 enumerable: false이므로 처리되지 않는다.
...
console.log(Object.getOwnPropertyDescriptors(foods));
...
/**
 * arr1.concat(arr2) : e두 배열의 요소를 합친 새 배열을 반환(imnutable)
 */
