...
public class App3 {
    public static void main(String[] args) {
        ...
        System.out.println(localDateTime); // 2024-03-27T12:50:19.441224100
        System.out.println(localDateTime.hashCode()); // 1390740262

        localDateTime.plusMinutes(60);
        System.out.println(localDateTime); // 2024-03-27T12:50:19.441224100
        // 무조건 새객체를 반환. 기존객체는 변경하지 않는다.
        System.out.println(localDateTime.hashCode()); // 1390740262
        ...
        System.out.println(localDateTime3); // 2024-03-26T14:08:36.555269400
        // 불변객체다
    }
}