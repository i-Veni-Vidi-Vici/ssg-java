 ...
 *
 * default : @Transactional 메소드 안에서 던져진 예외가 RuntimeException 후손인 경우만, rollback 처리한다. (기본값)
 * -> 모든 예외에 대해 rollback 처리하도록 처리할 예외 클래스를 Exception.class로 확장한다.
 */
@Transactional(
...
public class OrderService {
    ...
    // 트랜잭션 내에서 호출되었다면 기본 트랜잭션에 포함됨, 단독으로 호출했다면 다른 트랜잭션으로 처리될 것
    private int createOrderMenu(OrderMenuDto orderMenuDto) {
