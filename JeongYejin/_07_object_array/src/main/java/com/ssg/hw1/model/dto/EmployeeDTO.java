...
public class EmployeeDTO {
    ...
    public String information() {
        String str = "emp[%d] : %d, %s, %s, %s, %d, %c, %d, %.1f, %s, %s".formatted(this.empNo, this.empNo, this.empName, this.dept, this.job, this.age, this.gender, this.salary, this.bonusPoint, this.phone, this.address);
