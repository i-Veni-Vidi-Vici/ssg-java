 ...
 * - 단어 사이에 연결을 _로 하지 않는다. (Snake-Casing X)
 * - 한글로 변수명을 작성하는 것은 가능하나 자제한다. (인코딩 이슈에 노출)
...
//        String my name = "신사임당"; 공백 특수문자는 사용할 수 없다.
        ...
        // 관례적 명명법
        String jfaeilfjdfd = "abc";
        System.out.println(jfaeilfjdfd);
        int maxAge = 20; //카멜케이싱
        int MaxAge = 30; //클래스명을 제외한 변수, 메소드, 필드명은 모두 소문자로 시작하는 암묵적인 관례가 있다.

        // 사용자 이름, 상품코드, 결혼여부 변수명 만들어보기
        String userName = "정예진";
        long productCode = 1111;
        boolean isMarried = false; // 주로 is~, is생략가능
        boolean hasLicense = false; //형용사적
        String weddingYn = "N";

        String 이름 = "유관순"; // 한글은 자제
        ...
        int count = 0;
        int cnt = 0;
        double goHome = 3.7; // 동사는 잘 안씀
        double home = 3.7; // 변수형은 명사형, 메소드명은 동사형으로
