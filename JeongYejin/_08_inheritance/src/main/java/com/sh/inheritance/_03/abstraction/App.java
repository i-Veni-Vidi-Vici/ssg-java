...
public class App {
    public static void main(String[] args) {
        ...
        Computer computer2 = new Computer("com1234", "삼성", "갤럭시북", 2000000, LocalDate.now(), "i9", 32, 1000, "Windows11");
        System.out.println(computer2.getInfo());

        Tv tv1 = new Tv();
        System.out.println(tv1.getInfo());
        Tv tv2 = new Tv("tv4567", "엘지", "엘지롤러블TV", 5000000, LocalDate.now(), "8k", 100);
