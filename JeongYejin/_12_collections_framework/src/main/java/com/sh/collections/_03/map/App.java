 ...
 *      - key/value타입을 모두 String으로 한정함으로써 설정정보관리에 최적화되어 있기 때문이다.
 * </pre>
 */
public class App {
...
//        Map map2 = new HashMap<>();
        ...
        // put(K, V) 요소저장
//        map.put("홍길동", 23);
        System.out.println(map.put("홍길동", 23)); // 어떻게 여기서 null이 나오는지?
//        map.put("신사임당", 40); // int -> Integer.valueOf(40) auto-boxing처리
        System.out.println(map.put("신사임당", 40));
//        map.put(50, "이순신");

        // 중복된 key로 저장
        System.out.println(map.put("홍길동", 33));
...
//        System.out.println(removed);
        ...
        int value2 = map.get("신사임당"); // auto-unboxing
        System.out.println("홍길동 : " + value);
        System.out.println("신사임당 : " + value2);
