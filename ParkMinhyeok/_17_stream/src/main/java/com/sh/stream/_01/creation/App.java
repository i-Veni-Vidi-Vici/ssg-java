...
public class App {
    public static void main(String[] args) {
        ...
        // 병렬처리
        List<String> subject = Arrays.asList("java", "mysql", "jdbc", "html", "js");
//        subject.stream().forEach(System.out::println); // 싱글 쓰레드
        subject.parallelStream().forEach(System.out::println); // 멀티 쓰레드 (병렬처리)
    }
}
