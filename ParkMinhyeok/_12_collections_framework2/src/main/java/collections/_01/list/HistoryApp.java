 ...
 * 2. 특정 url 로 이동시 기존 url 은 backwardStack 에 쌓이고 url 로 이동한다.
 * 3. 특정 url 로 이동시 forwardStack 이 비어있지 않다면, 제거한다.
 * 4. 뒤로가기를 누르면, 현재 url 은 forwardStack 에 쌓이고, backwardStack 의 url 을 current 대입한다.
