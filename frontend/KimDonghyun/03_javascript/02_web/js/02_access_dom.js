 ...
 * - 태그객체(DOM객체)에는 $로 시작하는 관례적으로 변수명을 사용한다.
 */
const test1 = () => {
  // const li1 = 1234;
 ...
 * - 조회된 태그객체를 유사배열 HTMLCollection 로 반환
 * - 유사배열은 배열의 메소드를 사용할수 없고, for..in처리시에도 오류가 발생할 수 있다.
 * - 유사배열은 진짜배열로 변환후 배열처럼 사용가능하다.
 */
const test2 = () => {
...
const test4 = () => {
  ...
  const $notExist = document.querySelector("#sssssss");
