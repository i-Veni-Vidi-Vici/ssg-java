...
console.log(re1.test("a1b2c3".split(re1))); // [ 'a', 'b', 'c', '' ]
console.log(re1.test("a1b2c3".replace(re1, "*"))); // a*b*c*
console.log(re1.test("a1b2c3".match(re1))); // [ '1', '2', '3' ] 매칭된 결과를 배열로 반환
console.log(re1.test("a3b4c5".search(re1))); // 1 매칭된 문자열의 인덱스 반환
...
console.log(re.test('acbbbbbbb'));  // true
