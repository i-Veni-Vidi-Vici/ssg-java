...
const[a, b, c, d = 'ㅋㅋㅋㅋ'] = arr; // 해당 인덱스의 값이 존재하지 않으면, undefined를 반환
console.log(a, b, c, d); // 가 나 다 ㅋㅋㅋㅋ
...
const [sum, diff, protuct, quotient, remainder] = test2(30, 20);
console.log(sum, diff, protuct, quotient, remainder); // 50 10 600 1.5 10
