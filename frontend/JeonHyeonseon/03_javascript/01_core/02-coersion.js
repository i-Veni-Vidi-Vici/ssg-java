...
//  - Truthy value (true로 평가되는 값들) - 값이 있는 경우 123, 45.67, -100, "ㅋㅋㅋ", {비어있는 객체}, [비어있는 배열], Infinity(무한수)
...
console.log(Boolean("ㅋㅋㅋㅋ"), typeof Boolean("ㅋㅋㅋㅋ")); // true boolean
console.log(!!"ㅋㅋㅋㅋ", typeof !!"ㅋㅋㅋㅋ"); // true boolean