 ...
 * - 타입을 가리지 않고, 개수 제한 없이 배열을 제어할 수 있다. (실제로는 하나의 타입 요소를 관리)
 */
...
console.log(arr3[3]);
console.log(arr3[4]);
console.log(arr3[5]); // undefined -> 존재하지 않는 요소를 참조해도 오류가 발생하지 않음!
...
// length속성은 enumerable : false 이므로 처리되지 않음
...
cars.reverse(); // [ '소나타', '그랜져', '카니발' ]
console.log(cars); // [ '카니발', '그랜져', '소나타' ]
