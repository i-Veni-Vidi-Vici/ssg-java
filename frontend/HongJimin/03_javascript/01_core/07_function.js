...
console.log(func == func2); //true -> heap영역이 같은 곳을 바라보고 있으므로 주소값이 같음
...
runner(func, 5); // 🚗🚗🚗 5줄 출력 -> func가 f에 들어감

//3. 값으로써 리턴값으로 사용
const carFactoryBuilder = () => {
  return () => console.log('🚔');
};
// const carFactory = carFactoryBuilder; // ⛳얘가 가르키고 있는 함수 객체의 주소값을 주겠다는 의미
// const carFactory = () => {
//   return () => console.log('🚔');
// };

// const carFactory = carFactoryBuilder(); // ⛳ 호출 결과를 주겠다는 의미
