 ...
 * 
 * Hoisting(호이스팅)이란?
 * - 실제 실행전에 자바스크립트 실행 엔진에 의해 함수선언식은 먼저 끌어올려져서 처리됨.
 */
...
// arguments 숨은 참조 변수 : 호출시 전달한 모든 매개인자를 배열로 갖고 있다.
// 유효성검사용으로 사용가능하다.
...
/**
 * 나머지 파라미터 Rest Parameter : 매개변수부에서 복수 개의 값을 처리할 수 있는 변수
...
// 2. 몸통부에 {return;}절 생략 (return구문 한줄만 존재할때)
