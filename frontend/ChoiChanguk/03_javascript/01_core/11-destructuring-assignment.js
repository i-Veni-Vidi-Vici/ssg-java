...
// const [a,b]=arr;// 0번지, 1번지
// console.log(a,b);

// const [a,,b]=arr;// 0번지, 2번지

// const [a,b,c,d]=arr; // 해당 인덱스의 값이 존재하지 않으면, undefined를 반환
// console.log(a,b,c,d);

const [a,b,c,d="abcd"]=arr
console.log(a,b,c,d);
...
const test1=([name,kor,eng,math])=>{
    ...
    console.log(`${name}학생의 평균점수는 ${Math.round((kor+eng+math)/3)}입니다`);
};
...
const [sum,minus,multi,quo,remain]=test2(10,20);
console.log(sum,minus,multi,quo,remain);
...
const {id:code}=obj; 
// console.log(id);//id라는 변수에 code를 찾아서 넣어줘
console.log(code);
...
console.log(`안녕하세요 ${lastname}가의 ${firstname}`);
}
