...
// 크기 비교를 위해 숫자로 암묵적 형변환
console.log(10 > "5"); // 10 > 5 형변환후 처리 true

// 논리형으로의 암묵적 형변환
// - 논이값으로 평가되어야 하는 곳에서 일어난다.
...
if(-100) console.log('-100은 true입니다.');
if("ㅋㅋㅋ") console.log('"ㅋㅋㅋ"은 true입니다.');
if({}) console.log('{}은 true입니다.');
if([]) console.log('[]은 true입니다.');
if(Infinity) console.log('Infinity은 true입니다.');
 ...
 * - Number(), parseInt, parseDouble() 숫자로 변환
 * - Boolean(), !! 논리형으로 변환
 */
...
console.log(Number("123.456"), typeof parseInt("123.456")); // 123.456 number
console.log(Number("123.456"), typeof parseFloat("123.456")); // 123.456 number

console.log(!!"ㅋㅋㅋ", typeof Boolean("ㅋㅋㅋ")); // true boolean
