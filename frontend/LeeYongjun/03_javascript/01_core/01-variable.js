...
const str2 = "신사임당"
const str3 = "이순신"
console.log(str1, typeof str1); // ES6(ES2015) 추가된 Template String 문법 : `` 안에서 개행/탭문자를 인식. ${}표현식을 통해 다른 변수 출력가능 
...
function foo() {
    console.log('fpooooooooooooooooooooooo');
}
foo();
 ...
 *      타입체크를 미리 선행하는 코드를 작성하고 있다. (타입 스크립트)
 */
let z;
console.log(z);
