...
const user = {
    ...
    // 속성값의 타입이 function인 경우, '메서드'라고 한다.
    hi: function(){
    ...
    100 : '홍길동100',
    "user-car" :'소나타',
    "user favorite food": '푸드'
    
}; // 코드블럭(if, for, function 등)이 아니므로, ;로 종결처리
 ...
 * - 속성/메서드를 객체라는 namespace로 구분지어 관리할 수 있다.
 */
const calculator ={
    plus(a,b){
        return a+b;
