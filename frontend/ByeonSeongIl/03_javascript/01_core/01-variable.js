 ...
 * - 길이 제약없이 정수를 제어하는 타입
 */
const bigNum = 111111111111111111111111111111111111111111111111111111n; // 접미사 n을 통해  bigint를 명시
console.log(bigNum, typeof bigNum); // 111111111111111111111111111111111111111111111111111111n bigint
...
console.log(obj, typeof obj); // { id: 12345, type1: '객체' } object
...
/**
 * 자바스크립트는 동적타입언어이다.
 * - 정적타입언어 (c, c++, java, ...) 변수에 자료형이 고정된 언어, 컴파일타입에 타입체크가 가능하므로, 런타임 오류를 줄일 수 있다.
