...
public class ShallowCopy {
    ...
    public void test2() {
        int[] arr = {1, 2, 3};
        System.out.println("test 2:" + arr.hashCode());
        print(arr);
    }
     ...
     */
    public void test3(){
        String[] animals = getAnimalArray(); // 우항이 메소드로 호출
        System.out.println("test:" + animals.hashCode());
    ...
    /**
     *  사용자로 부터 두 정수를 입력받아 두 정수 사이의 수로 구성된 배열을 생성/출력하세요.
