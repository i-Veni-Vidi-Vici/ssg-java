 ...
 *
 *  문법
 *  1. 구현 할 인터페이스에 추상메소드가 딱 하나만 존재해야 한다.
 ...
 *      (x, y) -> {return x * y;}
 * 4. 우측블럭이 리턴절 한 줄인 경우, {}, return 키워드를 생략할 수 있다.
 *      (x, y) -> x * y
 * 5. 우측블럭이 실행코드 한줄만 가진 경우, {}을 생략할 수 있다.
 *      (k) -> {System.out.println(k); }
 *      (k) -> System.out.println(k) 블럭을 지울 수 있음
...
public class App {
    public static void main(String[] args) {
       ...
       // 곱하기 계산기객체 - 익명클래스
        ...
        result = multiplyCalculator.calc(50, 50);
        System.out.println(result);
