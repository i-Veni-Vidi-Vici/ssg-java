...
public class LiteralApp2 {
    ...
    public static void main(String[] args) {
        ...
        // 4. 문자와 문자 연산 - 문자는 정수로 변환 후 연산이 가능
        ...
        // 5. 문자와 정수 연산 - 문자는 정수로 변환 후 연산이 가능
        ...
        // 6. 문자와 실수 연산 - 문자는 실수로 변환 후 연산이 가능
        ...
        // 7. 문자열 연산 - 문자열은 더하기 연산만 지원
        // 나머지는 컴파일 에러
        System.out.println("hello" + "world"); // "helloworld"
        System.out.println();

        // 8. 문자열과 다른 값의 연산 - 모두 문자열로써 더하기 연산 처리
        ...
        // 9. 논리 값과 오칙 연산은 불가능
        //System.out.println(true + true); // 컴파일 에러
        //System.out.println(true - 123); // 컴파일 에러
        //System.out.println(true * false); // 컴파일 에러

        // 10. 문자열과 다른 타입의 값 더하기 심화
        //프로그램은 기본적으로 위에서 아래로 왼쪽에서 오른쪽으로 코드를 처리
