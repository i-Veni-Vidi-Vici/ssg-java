...
console.log(`0 == false : ${0 == false}`);    // true (false가 0(number)로 암묵적 형변환처리)
console.log(`0 == '' : ${0 == ""}`);          // true (""이 0(number)로 암묵적 형변환처리)
...
num % 2 == 0 || console.log("짝짝짝"); // 좌항이 참인경우 우항을 실행하지 않음 
num % 2 != 0 || console.log("홀홀홀"); // 좌항이 거짓인 경우 우항을 실행한다. 
