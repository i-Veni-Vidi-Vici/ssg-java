...
//        app.test1();
    ...
    /**
     * 1. 클래스 객체 가져오기
     * // 클래스당 한개씩 밖에 안 만들어지는게 class 객체임.
     *
     */
    ...
    private void test1() {
        ...
        Class clz2 = new DefaultAccount(10,"110-234-1234567",0).getClass(); // 객체를 만들고 꺼꾸로 참조함.
        System.out.println(clz2);
        System.out.println(clz1 == clz2); // 주솟값이 같나요? // true




        // try catch 해줘야된다. 예외처리
        try {
            Class clz3 = Class.forName("com.sh.spring.common.account.DefaultAccount"); // copy reference 함.
            System.out.println(clz3);
            System.out.println(clz1 == clz3);

            // 배열의 클래스 객체 가져오기 좀 까다로움
            // double 배열
            Class clz4 = Class.forName("[D"); // [D
            Class clz5 = double[].class;
            System.out.println(clz4);
            System.out.println(clz5);

            // String 배열
            Class clz6 = Class.forName("[Ljava.lang.String"); // [L 쓰면 스트링의 배열이다.
            Class clz7 = String[].class;
            System.out.println(clz6);
            System.out.println(clz7);

            //부모클래스 객체
            Class clz8 = clz1.getSuperclass(); // extends한 클래스의 부모클래스 객체가 나온다.
