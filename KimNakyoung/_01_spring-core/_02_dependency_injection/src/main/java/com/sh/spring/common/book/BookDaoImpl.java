 ...
 * - 이 빈은 BookDaoImpl  BookDao타입으로 DI가능하다 -> 부모 타입으로 스프링이 빈(객체)전달해주는거 가능하다 !
 *
 */

// 인터페이스의 구현클래스에다가 어노테이션 붙여야함
...
public class BookDaoImpl implements BookDao{
    ...
    public  BookDaoImpl() {
        ...
        this.bookMap.put(2L, new BookDto(1L,455454455,"칭찬은 고래도 춤추게 한다.", "고래", "고래출판", LocalDate.of(2005,5,5)));
    }
    @Override
