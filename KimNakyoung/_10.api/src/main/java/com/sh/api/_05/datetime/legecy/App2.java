 ...
 *  - 윤초(UTC 세계협정시에 사용하는 세슘원자시계와 태양시사이의 오차를 반영)를 반영하지 못한다.
 *
 *
 * </pre>
 *
...
//        Calendar ca = new Calendar(); // 뉴 연선자 사용불가
        ...
        //특정일자로 캘린더객체 생성
        // 2024-03-04 12:30:30
        // 월 조심 하세요 월 0부터 시작입니다 월 출력하고싶은 날짜에서 -1 해주세요 월만 !! 월우렁ㄹ
        ...
        int hour = sometime.get(Calendar.HOUR_OF_DAY); // 24시간 기준
        ...
        String weekday = switch(dayOfWeek){
            ...
            case 6 -> "금";
            case 7 -> "토";
            default ->  ""; // switch expression에서 default구문을 필수이다.
        }; // 세미콜론 필수 switch expression의 경우 마지막 세미콜론을 반드시 찍는다.
        System.out.println(weekday);
        System.out.println(amPm == 0 ? "오전" : "오후");

        //Calendar -> Date
        long millis = sometime.getTimeInMillis(); // unix time 반환
