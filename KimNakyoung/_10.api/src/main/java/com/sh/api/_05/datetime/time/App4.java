...
public class App4 {
    public static void main(String[] args) {
        ...
        System.out.println("초 사이 : " + duration.getSeconds());
        ...
        System.out.println("시간 차이 : " + ChronoUnit.MINUTES.between(past,future)); // 525600
        System.out.println("시간 차이 : " + ChronoUnit.SECONDS.between(past,future)); // 31536000
