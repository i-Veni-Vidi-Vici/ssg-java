 ...
 * Reflection을 사용해서 스프링에서는 런타임 시에 개발자가 등록한 빈을 애플레케이션 내에서 사용할 수 있게 하는 것이다.
 *
...
//        app.test3();
    ...
    private void test4() {
        ...
        */
        try {
            ...
            // IllegalAccessException private에 접근하는 거 아니야?
    ...
    private void test3() {
        ...
        try {
            ...
            // 필드값 가져오기
            Object bankCodeValue = bankCode.get(account); // 필드.get(객체)
    ...
    private void test2() {
        ...
        System.out.println(Arrays.toString(declaredConstructors)); // [public com.sh.spring.common.account.DefaultAccount(), public com.sh.spring.common.account.DefaultAccount(int,java.lang.String,long)]

        try {
            Constructor<DefaultAccount> constructor1 = (Constructor<DefaultAccount>) clz.getDeclaredConstructor(null);
            System.out.println(constructor1); // public com.sh.spring.common.account.DefaultAccount()
            DefaultAccount account1 = (DefaultAccount) constructor1.newInstance(null);
            System.out.println(account1); // DefaultAccount(bankCode=0, accountNo=null, balance=0)
            ...
            System.out.println(account2); // DefaultAccount(bankCode=30, accountNo=111-22-3333333, balance=1000000)
    ...
    private void test1() {
        ...
        System.out.println(clz1); // class com.sh.spring.common.account.DefaultAccount
        ...
        System.out.println(clz1 == clz2); // true // 클래스당 하나밖에 안 만들어지는 클래스 객체!
        ...
        try {
            ...
            // 배열의 클래스객체 가져오기 (고난도)
            Class clz4 = Class.forName("[D"); // Double의 D
            Class clz5 = double[].class;
            System.out.println(clz4); // class [D
            System.out.println(clz5); // class [D

            // 참조형 클래스배열의 클래스 객체
            Class clz6 = Class.forName("[Ljava.lang.String;"); // String의 배열
