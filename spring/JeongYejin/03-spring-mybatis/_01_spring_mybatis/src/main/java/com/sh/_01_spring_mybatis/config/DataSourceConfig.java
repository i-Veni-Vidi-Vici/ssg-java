...
public class DataSourceConfig {
    ...
    public HikariDataSource dataSource() {
        ...
        dataSource.setMaximumPoolSize(50); // 커넥션객체 최대수 50로 설정
...
//        sqlSessionFactoryBean.setDataSource(dataSource()); // dataSource 의존주입
        ...
        // 별칭 등록
//        sqlSessionFactoryBean.setTypeAliasesPackage("com.sh");
//        sqlSessionFactoryBean.addTypeAliases(MenuDto.class); // 풀네임 대신 별칭으로 접근 가능
//        sqlSessionFactoryBean.setTypeAliases(MenuDto.class); // 풀네임 대신 별칭으로 접근 가능
