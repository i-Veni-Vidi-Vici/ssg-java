...
/**
 * @Repository
 * - @Component의 후손 어노테이션이므로, @ComponentScan에 의해서 자동으로 Bean 등록
 *      - 이 Bean은 BookDaoImpl 또는 BookDao타입으로 DI 가능하다.
 */
@Repository("bookDao")
public class BookDaoImpl implements BookDao{
    ...
    public BookDaoImpl() {
        ...
        this.bookMap.put(2L, new BookDto(2L, 465761212, "칭찬은 고래도 춤추게 한다.", "고래", "고래출판", LocalDate.of(2005, 5, 5)));
    }
