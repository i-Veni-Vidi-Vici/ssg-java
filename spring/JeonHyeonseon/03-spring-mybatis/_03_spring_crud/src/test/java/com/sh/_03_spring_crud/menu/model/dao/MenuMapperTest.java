...
class MenuMapperTest {
    @Autowired
    private MenuMapper menuMapper; // 이걸 작성함으로써 의존주입 받을 수 있음
    ...
    void test1() {
        ...
        assertThat(menus)
                .isNotNull()
                .isNotEmpty()
                .allMatch((menu) -> menu != null); // 모든 요소가 Predicate에 대해 true를 반환해야 한다. (단정문)
    }
    ...
    void test5() {
        ...
        assertThat(categories)
                ...
                .allSatisfy((category) -> {
                    ...
                    assertThat(category.getRefCategoryCode()).isNotNull(); // where절에 ref_category_code is not null을 작성할 것이기에 작성함.
                });
    }
}