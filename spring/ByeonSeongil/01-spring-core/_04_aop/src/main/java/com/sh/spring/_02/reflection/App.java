...
//        app.test3();
     ...
     */
    private void test4() {
        DefaultAccount account = new DefaultAccount(20, "100-200-300000", 3_000);
...
=
        ...
        try {
            ...
            // invoke(타겟객체, ...매개인자): Objcet 리턴값을 반환한다.
            ...
            System.out.println(account); //DefaultAccount(bankCode=20, accountNo=100-200-300000, balance=503000)
    ...
    private void test3() {
        ...
        try {
            ...
            // private 일 경우 바로 접근 x
            // private 접근제한자 해제
            bankCode.setAccessible(true);
            Object bankCodeVale = bankCode.get(account);
            System.out.println(bankCodeVale);
    ...
    private void test2() {
        ...
        try {
            ...
            DefaultAccount account2 = constructor2.newInstance(30, "123-213", 1_000);
    ...
    private void test1() {
        ...
        Class clz2 = new DefaultAccount(10, "123-456", 10).getClass();
        System.out.println(clz2);
        System.out.println(clz1 == clz2); // true

        Class clz3 = null;
        try {
            clz3 = Class.forName("com.sh.spring.common.account.DefaultAccount");
            ...
            // 부모클래스 객체
            Class clz8 = clz1.getSuperclass(); // 부모클래스 객체(extends)
