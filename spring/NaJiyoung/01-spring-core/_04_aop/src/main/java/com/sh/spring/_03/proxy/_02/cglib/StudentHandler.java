...
public class StudentHandler implements InvocationHandler { // InvocationHandler가 jdk.dynamic.proxy의 것과 다르다
    ...
    public Object invoke(Object proxy, Method method,Object[] args) throws Throwable {
        ...
        System.out.println("Arrays.toString(args) : " + Arrays.toString(args)); // 매개인자 확인

        // 타겟메소드 호출
        Object returnValue = method.invoke(target, args); // student.study() 호출
