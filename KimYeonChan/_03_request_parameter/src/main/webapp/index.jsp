...
<form action="test" method="get">
  ...
  <br>
  <label>생일 : </label><input type="date" name="birthday" value="1998-08-12">
  <br>
  <label>성별 : </label>
...
<a href="test?name=홍길동&age=33&birthday=1998-08-12&gender=M&national=ko&hobbies=movie&hobbies=music">GET 요청</a>
<h2>POST</h2>
<form action="test" method="post">
  ...
  <br>
  <label>취미 : </label>
  <input type="checkbox" name="hobbies" id="movie2" value="movie" checked><label for="movie">영화</label>
  <input type="checkbox" name="hobbies" id="music2" value="music" checked><label for="music">음악</label>
