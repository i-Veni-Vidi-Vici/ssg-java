...
public class EmployeeDTO {
    ...
    public String information() {
        String inforamtionStr = "";
        inforamtionStr += empNo + ", ";
        inforamtionStr += empName + ", ";
        inforamtionStr += dept + ", ";
        inforamtionStr += job + ", ";
        inforamtionStr += age + ", ";
        inforamtionStr += gender + ", ";
        inforamtionStr += salary + ", ";
        inforamtionStr += bonusPoint + ", ";
        inforamtionStr += phone + ", ";
        inforamtionStr += address;
        return inforamtionStr;
    }
