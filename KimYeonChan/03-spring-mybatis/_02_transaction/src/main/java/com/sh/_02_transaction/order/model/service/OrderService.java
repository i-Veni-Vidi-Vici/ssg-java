...
/**
 * 클래스 레벨
 * - 하위 모든 메소드에 @Transactional 을 적용
 *
 * @Transactional 메소드 안에서 던져진예외가 RuntimeException 후손인 경우만, rollback 처리한다. (기본값)
 * -> 모든 예외에 대해 rollback
 */
@Transactional(
...
public class OrderService {
     ...
     * - sqlSessionTemplate#getMapper 는 더 이상 작성하지 않아도 된다.
     */
