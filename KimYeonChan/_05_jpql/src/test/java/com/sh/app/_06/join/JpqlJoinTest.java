 ...
 *
 * 조인의 종류
 * 1. 일반 조인 : 일반적인 SQL 조인을 의미 (내부 조인, 외부 조인, 세타 조인)
...
public class JpqlJoinTest {
    ...
    void test3() {
        ...
        assertThat(categoryList)
                .allMatch((category) -> category.getCategoryCode() != null);
    }
     ...
     *  2. MenuEntity#category 필드는 실제 사용되어질때 다시 조회하게 된다.
     *      이는 JPA의 N+1 이슈를 유발한다.(조회 성능을 심각하게 떨어뜨린다.)
     */
    @Test
    ...
    void test5() {
        ...
        String jpql = """
                ...
                """;
        // when
        TypedQuery<MenuEntity> query = entityManager.createQuery(jpql, MenuEntity.class);
    ...
    void test7() {
        ...
        // when
        TypedQuery<MenuCategoryResponseDto> query = entityManager.createQuery(jpql, MenuCategoryResponseDto.class);
    ...
    @Test
    @DisplayName("Aggregate 너머의 엔티티 참조하기 - 각각조회")
    void test8() {
        // given
        Long menuCode = 10L;
