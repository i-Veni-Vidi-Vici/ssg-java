...
public class VariableApp3 {
     ...
     * 변수 명명 규칙
     * - 지키지 않을 경우 컴파일 오류
     * - 지키지 않아도 컴파일 오류는 나지 않음, 자바개발자 사이에 혼동을 줄 수 있는 부분
     ...
     * - 단어 사이의 연결을 _로 처리하지 않는다.(Snake_Casing)
    ...
    public static void main(String[] args) {
        // 컴파일 오류 유발
        int age = 20;
        // double age = 20.0; // 블럭안에 동일한 변수 이름을 작성할 수 없다.
        // int true = 1; // 자바 예약어 사용할 수 없다.
        int Age = 20; // 대소문자를 구분한다. 변수명은 관례에 따라 소문자로 시작해야한다.
        boolean True = true; // 대소문자를 구분한다. 변수명은 관례에 따라 소문자로 시작해야한다.
        // String 1stName = "홍"; // 숫자로 시작할 수 없다.
        String _1stName = "홍"; // 특수문자 _는 허용한다.
        boolean $harp = false; // 특수문자 $는 허용한다.
        // String my name = "신사임당"; // 공백 특수문자는 사용할 수 없다.
        String myName = "신사임당"; // 카멜케이싱 적용케이스를 추천한다.

        // 관례적 명명법
        String fdsafdsafdsafdsafkjdkfjdkjfkfjdkjfkdjfkdjfkdjfkdj = "abc"; // 변수명 길에 제한은 없지만, 적절한 길이로 작성해야 한다.
        int maxAge = 20; // 카멜케이싱
        int MaxAge = 20; // 클래스명을 제외한 변수, 메소드, 필드명은 모두 소문자로 시작하는 암묵적인 관례가 있다.
        // 사용자 이름, 상품코드, 결혼여부
        String userName = "김연찬";
        long productCode = 12341234;
        boolean isMarried = false;

        String 이름 = "김연찬"; // 한글로 변수명을 작성하는 것은 가능하나 자제한다.
        ...
        double goHome; // 변수명은 명사형으로 작성한다. 메소드명은 동사형으로 작성한다.
        double home;

        boolean wannaBe; // 논리형은 형소사적으로 작성한다.
        boolean notMarried; // 긍정형으로 작성한다.
    }
}
