...
import com.sh.spring.common.student.SggStudent;
 ...
 * 3. Proxy.newProxyInstance(클래스 로더, 클래스 객체, InvocationHandler):
 * </pre>
 */
public class App {
    public static void main(String[] args) {
        // 1. Target 객체 생성
        Student student = new SggStudent();
        ...
        // 스프링 IoC Container 는 위와 같이 Proxy 빈을 생성 후 의존성주입한다.
        student.study(8);
        System.out.println();
