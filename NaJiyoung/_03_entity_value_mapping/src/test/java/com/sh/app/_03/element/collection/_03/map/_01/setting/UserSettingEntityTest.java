    ...
    void test3() {
        ...
        /*
            ...
            where
                us1_0.id=?
         */
        System.out.println(userSetting2); // UserSetting(id=1, userId=456, updatedAt=2024-07-09T11:58:33.266096, props={Notification=NO, Display=LIGHT})
        // 알림설정 변경
        transaction.begin();
        try {
//            userSetting2.changeProp("Notification", "YES"); // update
            userSetting2.removeProp("Display"); // delete
            transaction.commit();
            /*
                update
                    tbl_user_setting_map
