 ...
 */
public class App {
    public static final String ROOT = "NaJiyoung/_14_io/"; // 프로젝트루트 (상대경로)
    public static void main(String[] args) {
        File file = new File(ROOT + "test.txt"); // 프로젝트루트부터 시작하는 상대경로
//        File file = new File(ROOT, "test.txt"); // 부모디렉토리, 파일명
//        File file = new File("C:\\Workspaces\\java_workspace\\NaJiyoung\\_14_io"); // 절대경로(윈도우)
//        File file = new File("/Users/na-jiyoung/Projects/study_bootcamp/etc/copyme.txt"); // 절대경로(맥)

        System.out.println(file); // NaJiyoung\_14_io\test.txt 파일경로로 toString 오버라이드 되어 있음.
        System.out.println(file.getParent()); // NaJiyoung\_14_io
        ...
        try {
            ...
            System.out.println(file.getAbsolutePath()); // C:\Workspaces\java_workspace\NaJiyoung\_14_io\test.txt
        } catch (IOException e) {
            e.printStackTrace();
        }
