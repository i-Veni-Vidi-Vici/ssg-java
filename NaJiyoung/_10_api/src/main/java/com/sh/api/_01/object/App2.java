...
public class App2 {
    public static void main(String[] args) {
        ...
        Book book2 = new Book(2L, "목민심서", "정약용", 300000);
        Book book3 = new Book(2L, "목민심서", "정약용", 300000);
        ...
        System.out.println(book3 == book1); // false
        ...
        System.out.println(book1.equals(book4));    // 주소값이 같으므로 true

        // title이 null인 경우?
        Book book5 = new Book(2L, null, "정약용", 300000);
        Book book6 = new Book(2L, null, "정약용", 300000);
        System.out.println(book5.equals(book2));    // false, (this-book5, other-book2)
        System.out.println(book2.equals(book5));    // false, (this-book2, other-book5)
        System.out.println(book5.equals(book6));    // true

        // hashCode 확인
        System.out.println(book2.equals(book3));    // true
        System.out.println(book2.hashCode());    // 1554547125 -> -1740253887
        System.out.println(book3.hashCode());    // 617901222 -> -1740253887
