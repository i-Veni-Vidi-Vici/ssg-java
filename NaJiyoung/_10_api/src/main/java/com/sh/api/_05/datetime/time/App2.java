...
public class App2 {
    public static void main(String[] args) {
        ...
        System.out.println("월 : " + localDateTime.getMonth()); // Month객체 반환, Month객체는 총 12개
        System.out.println("월(value) : " + localDateTime.getMonthValue()); // 월에 해당하는 상수
        ...
        System.out.println("요일(value) : " + localDateTime.getDayOfWeek().getValue()); // WEDNESDAY
