 ...
 * <pre>
 * 객체지향 설계원칙 SOLID
 * - 단일책임원칙 Single Responsbility Principle : 객체는 하나의 책임을 가져야 한다.
 *
...
public class MemberMenu {
     ...
     * 2. MemberManager객체 saveMember(member) 저장됨
     */
...
//        members[2] = new Member(3L, "leeess", "1234", "이순신", LocalDateTime.now());
