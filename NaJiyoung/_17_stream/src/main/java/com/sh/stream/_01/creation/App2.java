 ...
 * 1. 스트림 생성
 * 2. 스트림 중간연산 (0 ~ n) intermediate operation
 * 3. 스트림 단말연산 (1) terminal operation
 *
 * 사용한 스트림은 재사용할 수 없다.
 * </pre>
 */
...
//        stream1.forEach(System.out::println);
        ...
        // builder가 제네릭메소드이므로 타입변수 선언할 것
        Stream<String> stream5 = Stream.<String>builder().add("홍길동").add("이순신").build();
    }
}
