...
//                    m.menuVo
//                from
//                    MenuVo as m <!-- Entity객체가 아니기 때문에 불가 -->
//                """;
        // when
...
//                .allMatch((menuVo) -> menuVo instanceof MenuVo);
    ...
    void test4_0() {
        ...
        String jpql = """
                ...
                """;
        // when
        Query query = this.entityManager.createQuery(jpql); // 반환 타입을 지정할 수 없으므로 Query를 써야한다
