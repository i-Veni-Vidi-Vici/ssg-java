 ...
 * 2. fetch 조인 : JPQL에서 성능 최적화를 위해 제공하는 기능으로 연관된 엔티티나 컬렉션을 한 번에 조회할 수 있다.
...
public class JpqlJoinTest {
    ...
    void test1() {
         ...
         */
        System.out.println(menus.size()); // 74, category_code가 null인 것 제외
        ...
        /*
            ...
            left join
                tbl_category c1_0
                    on m1_0.category_code=c1_0.category_code
         */
        System.out.println(menus.size()); // 76, category_code가 null인 것 포함
        menus.forEach(System.out::println);
        // then
        assertThat(menus).isNotNull();
    }
        ...
        /*
            ...
            join
                tbl_category c1_0
                    on m1_0.category_code=c1_0.category_code
         */
        System.out.println(categories.size()); // 8, category_code가 null 또는 7(7인 메뉴 없음) 제외
        ...
        /*
            ...
            right join
                tbl_category c1_0
                    on m1_0.category_code=c1_0.category_code
         */
        System.out.println(categories.size()); // 12, category_code가 null 또는 7(7인 메뉴 없음) 포함
        categories.forEach(System.out::println);
        // then
        assertThat(categories).isNotNull();
    }
    ...
    void test5() {
        ...
        /*
            ...
            from
                ...
                tbl_category c1_0
         */
        System.out.println(rows.size()); // 912, 76 * 12
        rows.forEach((row -> {
     ...
     * 2. MenuEntity#category필드는 실제 사용되어질 때 다시 조회하게 된다.
