...
public class MenuJpqlTest {
    ...
    @Test
    @DisplayName("Menu - category 조회 - NativeQuery + 인터페이스 기반 DTO")
    void test2() {
        // given
        Long menuCode = 20L;

        // when
        IMenuCategoryResponseDto dto = menuRepository.findMenuAndCategoryWithSQL(menuCode); // 이 반환 코드를 인터페이스를 동적으로 만들어줌
        /**
         * Hibernate:
         *     select
         *         menu_code "menuCode",
         ...
         *         menu_code = ?
         */
        System.out.println(dto); // org.springframework.data.jpa.repository.query.AbstractJpaQuery$TupleConverter$TupleBackedMap@4eef8498
