...
public class App {
    public static void main(String[] args) {
        ...
        // bean의 destroyMethod를 명시적으로 호출하기 위해서는 process 종료 전에 context를 종료하면 된다.
        // stream 계열의 빈에서 자원 반환을 위해 destroyMethod를 사용한다.
        ((AnnotationConfigApplicationContext)context).close(); // 인터페이스여서 close가 안보임 -> 앞에다가 (AnnotationConfigApplicationContext)이거 붙혀줘야 함
