 ...
 *
 * CGLIB Proxy 객체 만드는 방법
 * 1. 실제 Target 객체 생성(인터페이스 업승ㅁ)
 * 2. Proxy 객체가 내부적으로 호출할 InvocationHandler 클래스 작성
 *     - 원래 target 객체 + 추가 적인 ㅇㄹ Invocation에 작성
...
public class App {
    public static void main(String[] args) {
        ...
        //2. InvocationHandler 객체(target 메소드 대리 호출, 부가 기능) 생성
        ...
        //스프링 IoC Container는 위와 같이 Proxy빈을 생성후, 의존 주입한다.
        proxy.study(8);
