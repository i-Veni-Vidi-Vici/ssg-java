...
public class RestaurantEntityTest {
    ...
    void test2() {
        ...
        Restaurant restaurant = Restaurant.builder()
                ...
                .name("ABC 파스타즈")
                .since(Year.of(1966))
                .address(new Address("서울시 강남구", "삼성동 123", "01234"))
                .grade(Grade.FIVE_STAR)
                .build();
        System.out.println(restaurant);
        // Restaurant(id=abc-1234, name=ABC 파스타즈, since=1966, grade=FIVE_STAR, address=Address(address1=서울시 강남구, address2=삼성동 123, zipCode=01234), createdAt=null, updatedAt=null)
        ...
        try {
             ...
             *     values
             *         (?, ?, ?, ?, ?, ?, ?, ?, ?)
             * Restaurant(id=abc-1234, name=ABC 파스타즈, since=1966, grade=FIVE_STAR, address=Address(address1=서울시 강남구, address2=삼성동 123, zipCode=01234), createdAt=2024-07-05T11:36:44.707501, updatedAt=2024-07-05T11:36:44.707501)
             */
        } catch (Exception e) {
...
//        entityManager.detach(restaurant); // 선택 사항
