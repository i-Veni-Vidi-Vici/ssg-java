 ...
 *     - Serializable 인터페이스를 구현한 타입만 지원.만약, 필드를 가지고 있다면, 모든 필드 역시 Serializable 인터페이스를 구현하고 있어야 함
 *
 * </pre>
 */
public class App4 {
    public static void main(String[] args) {
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream(target)))) { //FileOutputStream 객체는 파일 루트를 받기도 함
