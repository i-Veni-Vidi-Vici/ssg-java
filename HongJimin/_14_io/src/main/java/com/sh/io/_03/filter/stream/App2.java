 ...
 *        - System.in 표준 입력(키보드)
 *
 *      Scanner jdk1.5에 추가되기 전에는 사용자 입력을 위와 같이 처리했다.
 *      표준입출력스트림을 사용 후에는 절대 close 하지 않는다.
 *
 * </pre>
 */
public class App2 {
    public static void main(String[] args) {
        ...
        try {
            ...
            bw.write("abcdef"); //콘솔에 내부 버퍼를 이용해 출력!
            bw.flush(); //표준 출력은 닫지 않으므로, 명시적으로 flush를 호출해 내부 버퍼를 출력!
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
