 ...
 */
@SpringBootTest // Spring에서 테스트를 한다면, 무조건 필요함
class MenuServiceTest {
    ...
    void test3() {
        ...
        // when
        List<MenuDto> menuDtos = menuService.findByCategoryCode(categoryCode);
        ...
        assertThat(menuDtos)
                .isNotNull()
                .isNotEmpty()
                .allMatch((menuDto -> menuDto.getCategoryCode() == categoryCode));
    }
