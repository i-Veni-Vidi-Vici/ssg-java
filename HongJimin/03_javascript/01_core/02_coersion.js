...
console.log(10 > "5"); // 10 > 5 형변환후 처리 true

// ✨논리형으로의 암묵적 형변환✨
// - 논리값으로 평가되어야 하는 곳에서 일어남
...
if(123) console.log(`123는 true입니다.`); // 123는 true입니다.
if(45.67) console.log(`45.67는 true입니다.`); //45.67는 true입니다.
if(-100) console.log(`-100는 true입니다.`); // -100는 true입니다.
if("ㅋㅋㅋ") console.log(`"ㅋㅋㅋ"는 true입니다.`); // "ㅋㅋㅋ"는 true입니다.
if({}) console.log(`{}는 true입니다.`);// {}는 true입니다.
if([]) console.log(`[]는 true입니다.`); //[]는 true입니다.
if(Infinity) console.log(`Infinity는 true입니다.`); //Infinity는 true입니다.

if(!0) console.log(`0는 false입니다.`);
if(!0.0) console.log(`0.0는 false입니다.`);
if(!"") console.log(`""는 false입니다.`);
if(!undefined) console.log(`undefined는 false입니다.`);
...
console.log((123).toString(), typeof (123).toString()); // 123 string (123 원시값에 대해 임시적으로 Wrapper객체를 생성해 메소드 호출 가능)
