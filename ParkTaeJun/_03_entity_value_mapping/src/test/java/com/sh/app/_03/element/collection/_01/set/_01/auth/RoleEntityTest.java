...
public class RoleEntityTest {
    ...
    void test4() {
        ...
        try {
            ...
            Set<String> newPermission = Set.of("/member/members", "/manager/products");
            role.changePermissions(newPermission);
            transaction.commit();
            /**
             * tbl_role_permission_0301 테이블에서 ROLE_MANAGER 관련 행을 모두 삭제후에 다시 insert한다.
             */
